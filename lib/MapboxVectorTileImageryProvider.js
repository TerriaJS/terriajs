...
var MapboxVectorTileImageryProvider = function (csvItem, colorFunc, subdomains) {
...
MapboxVectorTileImageryProvider.prototype.buildImageUrl = function(x, y, level) {
    return this._url.replace('{s}', this._getSubdomain(x, y, level)) + level + '/' + x + '/' + y + '.' + this._fileExtension + '?access_token=' + this._accessToken;
};
