...
MapboxVectorTileImageryProvider.prototype._buildImageUrl = function(x, y, level) {
    // TEMP (for testing switching between pre-generated tiles and tiles that are generated on-the-fly)
    var url = (level >= 12) ? this._url.replace('SA4', 'SA4b') : this._url;

    return URI.expand(url, {
        x: x,
        y: y,
        z: level,
