...
var PointParameterEditor = function(options) {
    ...
    knockout.defineProperty(this, 'value', {
        get: function() {
            if (!definedNotNull(knockout.getObservable(this.parameterValues, this.parameter.id))) {
...
PointParameterEditor.prototype.show = function(container) {
    loadView(require('fs').readFileSync(__dirname + '/../Views/PointParameterEditor.html'), container, this);
};
...
PointParameterEditor.prototype.selectPointOnMap = function() {
    ...
    var pickPointMode = new MapInteractionMode('Select a point by clicking on the map.');
