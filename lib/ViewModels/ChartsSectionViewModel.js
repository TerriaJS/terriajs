...
var ChartsSectionViewModel = function(nowViewingTab, catalogMember) {
...
ChartsSectionViewModel.createForCatalogMember = function(nowViewingTab, catalogMember) {
    if (!defined(catalogMember.charts)) {
        return undefined;
    }

    return new ChartsSectionViewModel(nowViewingTab, catalogMember);
};
