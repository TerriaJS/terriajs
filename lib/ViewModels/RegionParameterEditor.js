...
var RegionParameterEditor = function(catalogFunction, parameter, parameterValues) {
    ...
    knockout.defineProperty(this, 'regionProvider', {
        get: function() {
            ...
            if (requiredRegionType instanceof RegionProvider) {
                return requiredRegionType;
            } else if (typeof requiredRegionType === 'string') {
                // TODO: resolve the string region type name to a RegionProvider instance.
            } else {
                // The region type is specified by the value of another parameter.
                return parameterValues[requiredRegionType.parameter];
            }
        }
    });
