...
var createGlobalBaseMapOptions = function(terria, bingMapsKey) {
    ...
    // Watercolor base map from http://maps.stamen.com
    var watercolor = new OpenStreetMapCatalogItem(terria);
    watercolor.name = 'Watercolour';
    watercolor.url = '//stamen-tiles-{s}.a.ssl.fastly.net/watercolor';
    watercolor.ignoreUnknownTileErrors = true;

    watercolor.attribution = 'Map tiles by Stamen Design, under CC BY 3.0. Data by OpenStreetMap under CC BY SA';

    watercolor.opacity = 1.0;
    result.push(new BaseMapViewModel({
        image: require('../../wwwroot/images/watercolor.png'),
        catalogItem: watercolor
    }));
