...
var createGlobalBaseMapOptions = function(terria, bingMapsKey) {
    ...
    // this should be {s} but this imagery provider doesn't support subdomains yet.
    positron.url = 'http://1.basemaps.cartocdn.com/light_all/';
    ...
    result.push(new BaseMapViewModel({
        image: terria.baseUrl + 'images/positron.png',
    ...
    // this should be {s} but this imagery provider doesn't support subdomains yet.
    darkMatter.url = 'http://1.basemaps.cartocdn.com/dark_all/';

    darkMatter.attribution = '© OpenStreetMap contributors ODbL, © CartoDB CC-BY 3.0';

    darkMatter.opacity = 1.0;
    result.push(new BaseMapViewModel({
        image: terria.baseUrl + 'images/dark-matter.png',
