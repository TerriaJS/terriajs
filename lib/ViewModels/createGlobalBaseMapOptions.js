...
var createGlobalBaseMapOptions = function(terria, bingMapsKey) {
    ...
    if (terria.userProperties.showTileBoundaries) {
        var tileBoundaries = new ImageryLayerCatalogItem(terria);
        tileBoundaries._createImageryProvider = function() {
            return new TileCoordinatesImageryProvider();
        };
        Object.defineProperty(tileBoundaries, 'type', {
            get: function() { return 'TileBoundaries'; }
        });
        Object.defineProperty(tileBoundaries, 'typeName', {
            get: function() { return 'TileBoundaries'; }
        });
        bingMapsAerialWithLabels = new CompositeCatalogItem(terria, [bingMapsAerialWithLabels, tileBoundaries]);
        bingMapsAerialWithLabels.name = 'Bing Maps Aerial with Labels';
    }
