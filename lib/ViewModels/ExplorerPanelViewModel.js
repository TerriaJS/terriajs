...
var getElement = require('../../Cesium/Source/Widgets/getElement');
...
var ExplorerPanelViewModel = function(options) {
    ...
    if (defined(options.mapElementToDisplace)) {
        var that = this;
        knockout.getObservable(this, 'isOpen').subscribe(function() {
            ...
            if (defined(that.application.leaflet)) {
                setTimeout(function() {
                    if (defined(that.application.leaflet)) {
                        that.application.leaflet.map.invalidateSize();
                    }
                }, 300);
            }
