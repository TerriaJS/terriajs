...
var ExplorerPanelViewModel = function(options) {
    ...
    knockout.track(this.terria, ['activeTabIndex']);
    ...
    if (this.terria.activeTabIndex >= this.tabs.length) {
        this.terria.activeTabIndex = 0;
    }

    if (this.tabs.length > 0) {
        this.activateTab(this.tabs[this.terria.activeTabIndex], false);
    }
...
ExplorerPanelViewModel.prototype.activateTab = function(tab, openPanel) {
    ...
    this.terria.activeTabIndex = this.tabs.indexOf(tab);
};
...
ExplorerPanelViewModel.prototype.getActiveTabIndex = function() {
    return this.terria.activeTabIndex;
};
