...
var FeatureInfoPanelViewModel = function(options) {
    ...
    knockout.track(this, ['isVisible', 'name', 'message', 'sections', 'unselectFeaturesOnClose', 'createFakeSelectedFeatureDuringPicking', 'maxWidth', 'maxHeight']);
...
function newSectionfromFeature(panel, feature) {
    return new FeatureInfoPanelSectionViewModel(panel.terria.clock, feature, panel.maxHeight);
}
