...
FeatureInfoPanelViewModel.prototype.showFeatures = function(features) {
    ...
    when(features.allFeaturesAvailablePromise, function() {
        ...
        console.log(defined(feature.properties));

        if (defined(feature.properties)) {
            console.log(feature.imageryLayer);
            var data = feature.properties.getValue(feature),
                template = feature.imageryLayer.infoTemplate;
