        ...
        if (object.hasOwnProperty(key)) {
            ...
            if (definedNotNull(value)) {
                if(typeof value === 'object') {
                    if(isArray(value)) {
                        if(value.every(isArray)) {
                            result.push({ key: key, value: value, pivot: true });
                        } else {
                            result.push({ key: key, value: convertToExplicitTree(value, true), pivot: false });
                        }
                    } else {
                        if(objectIsArray) {
                            result.push({ key: null, value: convertToExplicitTree(value, false), pivot: false });
                        } else {
                            result.push({ key: key, value: convertToExplicitTree(value, false), pivot: false });
                        }
                    }
                } else {
                    result.push({ key: key, value: value, pivot: false });
                }
            }
        }
    }
