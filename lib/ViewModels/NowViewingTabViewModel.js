...
var AsyncResultSectionViewModel = require('./AsyncResultSectionViewModel');
...
var ShortReportSectionViewModel = require('./ShortReportSectionViewModel');
...
var NowViewingTabViewModel = function(options) {
    ...
    this.nowViewing.showNowViewingRequested.addEventListener(function() {
        this.activate();
    }, this);
};
