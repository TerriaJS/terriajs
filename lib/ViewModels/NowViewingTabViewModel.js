...
NowViewingTabViewModel.prototype.urlIsImage = function(url) {
...
NowViewingTabViewModel.prototype.getItemControls = function(item) {
    var right = CatalogMemberControl.rightSideItemControls(item);
    var left = CatalogMemberControl.leftSideItemControls(item);
