...
BooleanParameterEditor.prototype.show = function(container) {
    loadView('<label><input type="checkbox" data-bind="checked: value, attr { title: parameter.description }" /> <span class="parameter-editor-heading" data-bind="text: parameter.name"></span></label>', container, this);
};
