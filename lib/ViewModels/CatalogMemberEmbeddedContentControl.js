...
/**
 * The view-model for an embedded control for catalog members. Clicking the control shows the
...
var CatalogMemberEmbeddedContentControl = function(catalogMember) {
     ...
     * @type {String}
     */
    this.name = 'View the embedded content associated with this catalog member.';
