...
DataCatalogTabViewModel.prototype.registerLeftSideItemControl = function(key, constructor) {
    leftSideControls[key] = constructor;
};


DataCatalogTabViewModel.prototype.registerRightSideItemControl = function(key, constructor) {
    rightSideControls[key] = constructor;
};
...
DataCatalogTabViewModel.prototype._getItemControls = function(item, controlList) {
    ...
    for (var key in controlList) {
        ...
        if (defined(item[controlList[key].requiredPropertyName()]) ||
            ...
            var Constructor = controlList[key];
            controls.push(new Constructor(item));
        }
    }
    return controls;
};
