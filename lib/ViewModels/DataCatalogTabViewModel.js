...
var rightSideControls = {};
var leftSideControls = {};
...
DataCatalogTabViewModel.prototype._registerItemControl = function(key, constructor, propertyName, controlList) {
    ...
    controlList[key].constructor = constructor;
    controlList[key].requiredPropertyName = propertyName;
};


DataCatalogTabViewModel.prototype.registerLeftSideItemControl = function(key, constructor, propertyName) {
    this._registerItemControl(key, constructor, propertyName, rightSideControls);
};


DataCatalogTabViewModel.prototype.registerRightSideItemControl = function(key, constructor, propertyName) {
    this._registerItemControl(key, constructor, propertyName, leftSideControls);
};


DataCatalogTabViewModel.prototype._getItemControls = function(item, controlList) {
    var controls = [];
...
DataCatalogTabViewModel.prototype.getLeftSideItemControls = function(item, controls) {
    return this._getItemControls(item, leftSideControls);
};


DataCatalogTabViewModel.prototype.getRightSideItemControls = function(item) {
    return this._getItemControls(item, rightSideControls);
};
