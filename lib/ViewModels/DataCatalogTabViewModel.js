...
DataCatalogTabViewModel._registerItemControl = function(key, constructor, propertyName, controlList) {
...
DataCatalogTabViewModel.registerLeftSideItemControl = function(key, constructor, propertyName) {
    this._registerItemControl(key, constructor, propertyName, rightSideControls);
};


DataCatalogTabViewModel.registerRightSideItemControl = function(key, constructor, propertyName) {
