...
us via email at '+that.terria.supportEmail+'.'
    ...
    // Set minimum zoom distance to 25 meters. Default is 1m.
    // Zoom crashes through terrain if the rate of zoom is higher than terrain
    // resolution rate and the height at the more detailed LOD is higher than
    // previous LOD.
    scene.screenSpaceCameraController.minimumZoomDistance = 25.0;
