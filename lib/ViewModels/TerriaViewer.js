...
function changeQuality(viewer) {
  if (defined(viewer.terria.cesium)) {
    ...
    switch (viewer.terria.quality) {
      case 1:
        terria.cesium.viewer.resolutionScale = devicePixelRatio;
        terria.cesium.viewer.scene.globe.maximumScreenSpaceError = 1;
        break;
      case 2:
        terria.cesium.viewer.scene.globe.maximumScreenSpaceError = 4.0 / 3.0;
        break;
      default:
        terria.cesium.viewer.resolutionScale = 1;
        terria.cesium.viewer.scene.globe.maximumScreenSpaceError = 1;
        break;
    }
  }
