...
var cesiumRequestAnimationFrame = require("terriajs-cesium/Source/Core/requestAnimationFrame").default;
...
var createWorldTerrain = require("terriajs-cesium/Source/Core/createWorldTerrain").default;
var Credit = require("terriajs-cesium/Source/Core/Credit").default;
var CreditDisplay = require("terriajs-cesium/Source/Scene/CreditDisplay").default;
...
var EllipsoidTerrainProvider = require("terriajs-cesium/Source/Core/EllipsoidTerrainProvider").default;
...
var FrameRateMonitor = require("terriajs-cesium/Source/Scene/FrameRateMonitor").default;
...
var KeyboardEventModifier = require("terriajs-cesium/Source/Core/KeyboardEventModifier").default;
...
var SingleTileImageryProvider = require("terriajs-cesium/Source/Scene/SingleTileImageryProvider").default;
...
function changeUseNativeResolution(viewer) {
  if (defined(viewer.terria.cesium)) {
    ...
    if (useNativeResolution) {
      terria.cesium.viewer.resolutionScale = (1.0 / devicePixelRatio) * 2;
    } else {
      terria.cesium.viewer.resolutionScale = 1.0 / devicePixelRatio;
    }
    // After changing resolutionScale, you need to call terria.cesium.viewer.resize() for it to take effect.
    terria.cesium.viewer.resize();
  }
}
...
TerriaViewer.prototype.selectCesium = function() {
  ...
  require.ensure(
    ...
    function() {
      ...
      var DataSourceDisplay = require("terriajs-cesium/Source/DataSources/DataSourceDisplay").default;
      var Cesium = require("../Models/Cesium");
