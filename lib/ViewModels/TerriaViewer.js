   ...
   //create leaflet viewer
    ...
    if (d) {
        map.attributionControl.setPrefix(d.element.outerHTML +
            (this._defaultTerriaCredit && this._defaultTerriaCredit._html) + 
...
function initializeTerrainProvider(terriaViewer) {
    ...
    if (!terriaViewer.terria.configParameters.hideTerriaLogo){
      ...
      terriaViewer._defaultTerriaCredit = new Credit('<a id="terriaLogo" href="https://terria.io/" target="_blank" rel="noopener noreferrer" ><img src="' + terriaLogo + '" title="Cesium ion"/></a>', true);
