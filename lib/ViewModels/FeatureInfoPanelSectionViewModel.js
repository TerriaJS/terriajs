...
var FeatureInfoPanelSectionViewModel = function(terria, feature) {
    ...
    this.isOpen = (this.terria.selectedFeature === this.feature) ? true : false ;
    ...
    knockout.track(this, ['isOpen', 'name', 'info', 'catalogItemName']);
...
FeatureInfoPanelSectionViewModel.prototype.toggleOpen = function() {
    ...
    console.log(this.terria.selectedFeature);
