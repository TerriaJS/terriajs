...
var FeatureInfoPanelSectionViewModel = function(terria, feature) {
    ...
    this.chartViewModel = new ChartViewModel(this, 'http://services.aremi.nicta.com.au/aemo/v4/duidcsv/LKBONNY3?offset=24h', {});

    knockout.track(this, ['name', 'info', 'catalogItemName', 'chartViewModel']);
    knockout.track(this.terria, ['selectedFeature']);
    knockout.track(this.featureInfoPanelViewModel, ['maxSectionHeight', 'maxWidth']);

    var that = this;
    knockout.getObservable(that.featureInfoPanelViewModel, 'maxWidth').subscribe(function() {
        // TODO!!!
        var elementWidth = document.getElementsByClassName('feature-info-panel-section-content')[0].offsetWidth;
