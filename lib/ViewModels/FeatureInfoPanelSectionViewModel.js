...
// A Mustache function used to insert commas into numbers
function addCommas(text, render) {
    return formatNumberWithCommas(render(text));
}
...
function generateCsvData(data) {
    ...
    for (var i = 0; i < keys.length; i++) {
        ...
        if (type === 'function') {
            // Ignore template functions we've added here, such as 'addcommas'.
            continue;
        }
...
// function addCommasToNumbers(properties) {
//     // Eg. {a: 1234567} -> {a: "1,234,567"}
//     // Modifies properties in-place.
//     for (var key in properties) {
//         if (properties.hasOwnProperty(key)) {
//             if (typeof properties[key] === 'number') {
//                 properties[key] = formatNumberWithCommas(properties[key]);
//             }
//         }
//     }
// }
