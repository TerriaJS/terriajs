 ...
 * @param {Boolean} [isOpen] Is this section open? (defaults to true)
  */
var FeatureInfoPanelSectionViewModel = function(clock, feature, maxHeight, isOpen) {
    this.clock = clock;
    ...
    knockout.track(this, ['name', 'info', 'maxHeight', 'isOpen']);
