...
var FeatureInfoPanelSectionViewModel = function(terria, feature) {
    ...
    this.catalogItemName = defined(this.catalogItem) ? this.catalogItem.name : '';
    this.template = defined(this.catalogItem) ? this.catalogItem.featureInfoTemplate : undefined;
