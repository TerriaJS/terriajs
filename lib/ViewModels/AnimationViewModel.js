...
function updateForNewTopLayer(animationViewModel) {
    ...
    {
        _setClockCurrentTime(animationViewModel);
    }
 ...
 * @private
 */
function _setClockCurrentTime(animationViewModel)
{
    var terria = animationViewModel.terria;
    ...
    if (defined(terria.timeSeriesStack.topLayer.initialTimeSource))
    {
        var startTime = terria.timeSeriesStack.topLayer.initialTimeSource;
        switch(startTime)
        {
            case "start":
                terria.clock.currentTime = terria.clock.startTime;
            ...
            default:
                ...
                try {
                    ...
                    throw new TerriaError('No good initialTimeSource specified in config file: ' + startTime);
                }
