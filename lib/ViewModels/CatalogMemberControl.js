 ...
 */
var CatalogMemberControl = function(catalogItem) {
...
CatalogMemberControl.leftSideItemControls = function(item) {
    return getItemControls(item, CatalogMemberControl._leftControls);
};


CatalogMemberControl.rightSideItemControls = function(item) {
    return getItemControls(item, CatalogMemberControl._rightControls);
};
