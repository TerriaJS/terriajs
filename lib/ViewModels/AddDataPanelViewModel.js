...
/*global require,ga*/
var ArcGisMapServerCatalogGroup = require('../Models/ArcGisMapServerCatalogGroup');
...
AddDataPanelViewModel.prototype.addUrl = function() {
    ...
    if (this.dataType === 'auto') {
        ...
        var others = [loadMapServer, loadFile];
    ...
    } else if (this.dataType === 'esri-mapServer-group') {
...
function loadMapServer(viewModel) {
    var mapServer = new ArcGisMapServerCatalogGroup(viewModel.terria);
