...
var SingleTabExplorerPanelViewModel = function(options) {
 ...
 */
SingleTabExplorerPanelViewModel.prototype.show = function(container) {
    loadView(require('fs').readFileSync(__dirname + '/../Views/SingleTabExplorerPanel.html', 'utf8'), container, this);
};

SingleTabExplorerPanelViewModel.prototype.addTab = function(tabViewModel) {
...
SingleTabExplorerPanelViewModel.prototype.activateTab = function(tab, openPanel) {
    for (var i = 0; i < this.tabs.length; ++i) {
...
SingleTabExplorerPanelViewModel.prototype.toggleOpen = function() {
    this.isOpen = !this.isOpen;
};

SingleTabExplorerPanelViewModel.prototype.open = function() {
    this.isOpen = true;
};

SingleTabExplorerPanelViewModel.prototype.close = function() {
    this.isOpen = false;
};

SingleTabExplorerPanelViewModel.create = function(options) {
    var result = new SingleTabExplorerPanelViewModel(options);
    result.show(options.container);
    return result;
};

module.exports = SingleTabExplorerPanelViewModel;
