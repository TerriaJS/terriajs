...
var ChartViewModel = function(chartPanelViewModel, containerViewModel, data, options) {
    ...
    var z = new DataCatalogItem(containerViewModel.terria, this.data);
    z.load().then(function() {
        console.log('success', z);
        var group = new CatalogGroup(containerViewModel.terria);
        group.name = 'Chart Data';
        group.description = 'A group for chart data.';
        group.add(z);
        containerViewModel.terria.catalog.group.add(group);
    }).otherwise(function () {
