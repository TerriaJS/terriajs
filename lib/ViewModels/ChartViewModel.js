...
ChartViewModel.prototype.expand = function() {
    var chartPanel = this.containerViewModel.featureInfoPanelViewModel.chartPanelViewModel;
    chartPanel.open();
    var fullOptions = clone(this.options);
    fullOptions.showRangeSelector = true;
    fullOptions.canExpand = false;
    var chartViewModel = new ChartViewModel(this, fullOptions.src, fullOptions);
