...
/*global require,ga*/
var CameraFlightPath = require('../../Cesium/Source/Scene/CameraFlightPath');
...
var IntersectionTests = require('../../Cesium/Source/Core/IntersectionTests');
var knockout = require('../../Cesium/Source/ThirdParty/knockout');
var Matrix4 = require('../../Cesium/Source/Core/Matrix4');
var Ray = require('../../Cesium/Source/Core/Ray');
...
var NavigationViewModel = function(options) {
    ...
    this.application.afterViewerChanged.addEventListener(viewerChange);
