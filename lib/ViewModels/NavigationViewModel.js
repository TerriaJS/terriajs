...
var NavigationViewModel = function(options) {
    ...
    function viewerChange() {
        if (defined( that.terria.cesium)) {
            if (that._unsubscribeFromPostRender) {
                that._unsubscribeFromPostRender();
                that._unsubscribeFromPostRender = undefined;
            }

            that.showCompass = true;

            that._unsubscribeFromPostRender =  that.terria.cesium.scene.postRender.addEventListener(function() {
...
NavigationViewModel.prototype.show = function(container) {
    loadView(require('../Views/Navigation.html'), container, this);
};
