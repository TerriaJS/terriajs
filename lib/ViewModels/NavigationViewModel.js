...
var ResetViewNavControl = require('./ResetViewNavControl');
var ZoomInNavControl = require('./ZoomInNavControl');
var ZoomOutNavControl = require('./ZoomOutNavControl');
...
var NavigationViewModel = function(options) {
    ...
    if (!defined(this.controls)) {
        this.controls = [
            new ZoomInNavControl(this.terria),
            new ResetViewNavControl(this.terria),
            new ZoomOutNavControl(this.terria)
        ];
    }
