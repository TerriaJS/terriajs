...
import ReactSelect, { ActionMeta, OptionTypeBase, ValueType } from "react-select";
...
type SelectOnChangeHandler<OptionType extends OptionTypeBase, IsMulti extends boolean> = (
