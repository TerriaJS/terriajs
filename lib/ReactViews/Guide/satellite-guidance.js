export const guideData = [
  ...
  },
  {
    ...
    body:
      "You may need to adjust your zoom level to make satellite imagery visible on the map.",
    hidePrev: true
  },
  {
  ...
  },
  {
    ...
    body:
      "You can apply a range of styles, such as false-colour, to satellite imagery by clicking on the styles dropdown in your data workbench.",
