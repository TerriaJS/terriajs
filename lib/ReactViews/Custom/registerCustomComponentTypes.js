...
/* TODO EDATOS-3310: Esta función será necesaria únicamente
 * mientras los datos se traigan con mala codificación desde el CKAN
 */
/**
 * Decodifica un string codificado en UTF-8.
 * @param {String} s 
...
const registerCustomComponentTypes = function(terria) {
  ...
  function processChartNode(context, node, children) {
    ...
    var etiqueta = decode_utf8(context.feature.data.properties.ETIQUETA);
    const title = etiqueta || node.attribs["title"];
