...
const ConceptsSelector = createReactClass({
    ...
    getFillStyle(concept) {
      return defaultValue(concept.color, '#ffffff')
    },
    ...
    render() {
        // SB: so we have an array of data-things, each of which contains an array of DisplayVariablesConcepts, each containing an array of Concepts.
        // is this an array too many?
        ...
        function getConceptsForCategory(category) {
            function extractDisplayConcepts(concepts) {
                ...
                if (concepts.activeItems) { 
                    ...
                    const displayConcept = Object.assign({}, concepts, { parentName: category.categoryName })
