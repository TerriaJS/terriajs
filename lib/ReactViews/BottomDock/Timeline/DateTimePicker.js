...
const DateTimePicker = createReactClass({
    ...
    propTypes: {
        ...
        objectifiedDates: PropTypes.object,
    ...
    renderYearGrid() {
      const data = this.props.objectifiedDates;
    ...
    renderDayView() {
      ...
      const days = Object.keys(this.props.objectifiedDates[this.state.year][this.state.month]);
    ...
    renderHourView() {
      const timeOptions = this.props.objectifiedDates[this.state.year][this.state.month][this.state.day].map((m) => ({
        value: m,
    ...
    render() {
      if (this.props.objectifiedDates) {
        return (
