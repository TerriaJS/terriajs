...
function addViewSettings(terria, viewState, initSource) {
  ...
  if (terria.compareLeftItemId)
    initSource.compareLeftItemId = terria.compareLeftItemId;
  if (terria.compareRightItemId)
    initSource.compareRightItemId = terria.compareRightItemId;
