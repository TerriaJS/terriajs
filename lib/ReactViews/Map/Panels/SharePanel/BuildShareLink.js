...
function addViewSettings(terria, viewState, initSource) {
  ...
  if (terria.mainViewer.viewerMode === "cesium") {
    if (terria.mainViewer.viewerOptions.useTerrain) {
      viewerMode = "3d"; // eslint-disable-line i18next/no-literal-string
    } else {
      viewerMode = "3dSmooth"; // eslint-disable-line i18next/no-literal-string
    }
  } else {
    viewerMode = "2d"; // eslint-disable-line i18next/no-literal-string
  }
