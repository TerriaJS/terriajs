    ...
    return (
      ...
      >
        ...
        >
          ...
          <Spacing bottom={5} />
          <Text medium>
            Find useful tips on how to use the Digital Twin either by
            checking the video guides below or by contacting the team
            at <span className={Styles.link}>info@terria.io</span>.
          </Text>
          {/* <Spacing bottom={5} />
          <Box centered>
            <button
        ...
        >
          ...
          `}>
              <HelpPanelItem 
                ...
                background={"https://img.youtube.com/vi/Co5Fy1uhkb8/maxresdefault.jpg"}
              />
              <HelpPanelItem 
                terria={this.props.terria}
                viewState={this.props.viewState}
              ...
              <HelpPanelItem 
                ...
                background={"https://img.youtube.com/vi/khoRe7X5AWA/maxresdefault.jpg"}
              />
              <HelpPanelItem 
                terria={this.props.terria}
                viewState={this.props.viewState}
              ...
              <HelpPanelItem 
                ...
                background={"https://img.youtube.com/vi/YK_cKZL6kWI/maxresdefault.jpg"}
              />
          </Box>
        </Box>
      </div>
