    ...
    render() {
            ...
            return (
                <div className={classNames('chart-expand', {'raise-to-title': this.props.raiseToTitle})}>
                    <div className='chart-dropdown-button'>
                        {downloadButton}<Dropdown selectOption={this.expandDropdown} options={sourceNameObjects}>Expand&nbsp;▾</Dropdown>
                    </div>
                </div>
            );
        }
        ...
        return (
            <div className='chart-expand'>
                {downloadButton}<button className='btn btn--chart-expand' onClick={this.expandButton}>Expand</button>
            </div>
        );
    }
