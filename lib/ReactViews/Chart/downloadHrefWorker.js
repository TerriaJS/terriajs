...
onmessage = function(event) {
    const valueArrays = event.data;
    const combinedValueArrays = combineValueArrays(valueArrays);
    ...
    //     }
    // }
    const joinedRows = combinedValueArrays.map(function(row) { return row.join(','); });
