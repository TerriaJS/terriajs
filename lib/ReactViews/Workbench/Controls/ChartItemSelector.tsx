...
export const ChartItem: React.FC<React.PropsWithChildren<IChartItem>> =
  observer(({ chartItem }: IChartItem) => {
...
const ChartItemSelector: React.FC<React.PropsWithChildren<IChartItemSelector>> =
