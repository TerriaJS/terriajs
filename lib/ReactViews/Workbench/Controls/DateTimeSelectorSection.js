            ...
            <div className={Styles.datetimeSelector}>
                ...
                <div className={Styles.datetimeSelectorInner}>
                  <div className={Styles.datetimeAndPicker}>
                      <button className={Styles.datetimePrevious} disabled={currentIndex === 0} onClick={this.goToPreviousDate.bind(this, availableDates, currentIndex)} title='Previous time'><Icon glyph={Icon.GLYPHS.previous}/></button>
                      <span className={Styles.currentDate}>{defined(currentDate) && formatDateTime(currentDate)}</span>
                      <button className={Styles.datetimeNext} disabled={currentIndex === availableDates.length - 1} onClick={this.goToNextDate.bind(this, availableDates, currentIndex)} title='Next time'><Icon glyph={Icon.GLYPHS.next}/></button>
                  </div>
