...
const DateTimeSelectorSection = createReactClass({
    ...
    onNextButtonClicked() {
        this.updateIndex(this.getNextIndex());
    },

    onPreviousButtonClicked() {
        this.updateIndex(this.getPreviousIndex());
    },
    ...
    render() {
        ...
        const nextAvaliable = defined(this.getNextIndex());
        const previousAvaliable = defined(this.getPreviousIndex());
        return (
