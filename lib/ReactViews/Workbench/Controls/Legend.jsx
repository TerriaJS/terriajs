...
import createObserveModel from "../../createObserveModel";
                    ...
                    <Choose>
                        <When condition={this.props.item.isLoading}>
                            <li className={Styles.loader}>
                                <Loader
                                    message={this.props.item.loadingMessage}
                                />
                            </li>
                        </When>
                        <Otherwise>
...
const observedLegend = createObserveModel(Legend);
