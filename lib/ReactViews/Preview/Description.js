    ...
    return (
      <div className={Styles.description}>
        ...
        <If condition={catalogItem.dataUrlType === "local"}>
          <p>
            This file only exists in your browser. To share it, you must load it
            ...
            <Choose>
              ...
              <When condition={catalogItem.type === "wfs"}>
                <p key="wfs-description">
                  ...
                  , which transfers raw spatial data on request. It can be used
              ...
              <Choose>
                ...
                >
                  ...
                  <If condition={!hasDataUriCapability}>
                    ...
                    functionality needed to download this data as a file. Please
                    use Chrome, Firefox or Safari to download this data.
                  </If>
                </When>
                <Otherwise>
