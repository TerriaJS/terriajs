...
const Tooltip = {
    ...
    hide(tooltipElement) {
        // A bit flashy with visibility hidden; but opacity-0 div can get in front of other elements.
        tooltipElement.transition().style('opacity', 1e-6).style('visibility', 'hidden');
    }
