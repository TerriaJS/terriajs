...
class BaseChart {
   ...
   * @param  {ChartRenderer} renderContext Object containing various helper items which you may need for plotting.
  ...
  render(chart, chartData, renderContext) {
    throw new TerriaError(i18next.t("chart.notImplemented"));
  }
