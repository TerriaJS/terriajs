        ...
        if (!defined(domain)) {
            ...
            for (theseUnits in domain.y) {
               if (domain.y.hasOwnProperty(theseUnits)) {
                    ...
                    if (dataWithTheseUnits.length === 1 && defined(dataWithTheseUnits[0].axisMin)) {
                        thisYDomain[0] = dataWithTheseUnits[0].axisMin;
                    }
                    if (dataWithTheseUnits.length === 1 && defined(dataWithTheseUnits[0].axisMax)) {
                        thisYDomain[1] = dataWithTheseUnits[0].axisMax;
                    }
                }
