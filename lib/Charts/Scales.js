...
const Scales = {
    ...
    calculate(size, domain, data, xPadding=0) {
        ...
        function computeDomain() {
            ...
            // let importantSeries = data.filter(series => series.showAll);
            // if (importantSeries.length === 0) {
            //     importantSeries = data;
            // }
            // if (data.filter(series => series.showAll).length > 0) {
            //     data = data.filter(series => series.showAll);
            // }
