...
const LineChart = {
     ...
     * @param  {String} [state.tooltip.id] The id to use for the tooltip DOM element, defaults to 'linechart-tooltip-id'. Do not change this after creation.
     * @param  {String} [state.tooltip.className] The className to use for the tooltip DOM element, defaults to 'linechart-tooltip'. Do not change this after creation.
...
function showTooltip(selectedData, tooltipElement, tooltipSettings, g) {
    ...
    const chartBounds = g[0][0].parentElement.getBoundingClientRect();  // Strangely, g's own width can sometimes be far too wide.
