...
const mobileViews =['data', 'preview', 'nowViewing', 'search'];
...
export default class ViewState {
    constructor() {
        ...
        knockout.track(this, ['previewedItem', 'catalogSearch', 'modalVisible', 'modalTabIndex', 'userDataPreviewedItem', 'isDraggingDroppingFile', 'mobileView']);
    }
    ...
    // //mobile nowviewing
    // toggleNowViewing(bool){
    //     this.isNowViewingOnly = bool;
    // }
