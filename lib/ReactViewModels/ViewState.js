...
export default class ViewState {
    constructor(options) {
        ...
        this._userPropertiesSubscription = knockout.getObservable(terria.userProperties, 'hideWorkbench').subscribe(updateIsMapFullscreen);
        this._userPropertiesSubscription = knockout.getObservable(terria.userProperties, 'hideExplorerPanel').subscribe(updateIsMapFullscreen);
