...
export default class ViewState {
  constructor(options) {
    ...
    knockout.defineProperty(this, "explorerPanelIsVisible", {
      get: function() {
        const match = this.matchFromExplorer;
        return (
          match &&
          (match.path === CATALOG_MEMBER_ROUTE || match.path === CATALOG_ROUTE)
        );
      },
      set: function(bool) {
    ...
    // this._explorerPanelIsVisibleSubscription = knockout
    //   .getObservable(terria, "explorerPanelIsVisible")
    //   .subscribe(explorerPanelIsVisible => {
    //     if (
    //       defined(explorerPanelIsVisible) &&
    //       !explorerPanelIsVisible &&
    //       defined(this.history.push)
    //     ) {
    //       console.log("explorerPanelIsVisible is ", explorerPanelIsVisible);
    //       // this.history.push("/");
    //     }
    //   }, this);
