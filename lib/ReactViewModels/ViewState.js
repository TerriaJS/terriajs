...
export default class ViewState {
    constructor(options) {
        ...
        this.searchState = new SearchState({
            ...
            workbenchSearchProvider: options.workbenchDataSearchProvider,
    ...
    searchInWorkbenchData(query) {
        this.searchState.workbenchDataSearchText = query;
        this.searchState.searchWorkbenchData();
    }
