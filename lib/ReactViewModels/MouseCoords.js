...
export default class MouseCoords {
    ...
    prettyProjection(latitude, longitude, proj4Projection, proj4longlat, projectionUnits) {
    ...
    prettifyCoordinates(latitude, longitude, height, errorBar) {
        var result = {};
    ...
    cartographicToFields(coordinates, errorBar) {
        ...
        if (this.useProjection) {
            var prettyProjection = this.prettyProjection(latitude, longitude, this.proj4Projection, this.proj4longlat, this.projectionUnits);
            this.utmZone = prettyProjection.utmZone;
            this.north = prettyProjection.north;
            this.east = prettyProjection.east;
        }

        var prettyCoordinate = this.prettifyCoordinates(latitude, longitude, coordinates.height, errorBar);
