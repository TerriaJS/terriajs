...
import {prettifyCoordinates, prettifyProjection} from '../Models/prettyCoordinates';
...
export default class MouseCoords {
    ...
    cartographicToFields(coordinates, errorBar) {
        ...
        if (this.useProjection) {
            var prettyProjection = prettifyProjection(latitude, longitude, this.proj4Projection, this.proj4longlat, this.projectionUnits);
            this.utmZone = prettyProjection.utmZone;
            this.north = prettyProjection.north;
            this.east = prettyProjection.east;
        }

        var prettyCoordinate = prettifyCoordinates(latitude, longitude, coordinates.height, errorBar);
