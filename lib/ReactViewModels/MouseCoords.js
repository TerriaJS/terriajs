...
export default class MouseCoords {
    constructor() {
        ...
        this.accurateHeightTimer = undefined;
        ...
        this.debounce = debounce(this.sampleAccurateHeight, this.accurateSamplingDebounceTime);
    ...
    updateCoordinatesFromCesium(terria, position) {
        ...
        if (defined(pickedTriangle)) {
            ...
            this.debounce(globe.terrainProvider, intersection);
    ...
    debounceSampleAccurateHeight(globe, position) {
        ...
        Cartographic.clone(position, this.lastHeightSamplePosition);

        const terrainProvider = globe.terrainProvider;
        if (!(terrainProvider instanceof EllipsoidTerrainProvider)) {
            if(defined(this.accurateHeightTimer)) this.accurateHeightTimer.cancel();
            this.accurateHeightTimer = debounce(this.sampleAccurateHeight, this.accurateSamplingDebounceTime);
            this.accurateHeightTimer(terrainProvider, position);
        }
    }
    ...
    sampleAccurateHeight(terrainProvider, position) {
        if (this.tileRequestInFlight) {
            ...
            this.debounce(terrainProvider, position);
            return;
        }
