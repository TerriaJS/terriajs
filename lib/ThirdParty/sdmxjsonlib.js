...
lib.response._mapComponents = function(msg, iterator, ignoreDatasetLevel) {
  ...
  ["dimensions", "attributes"].forEach(function(type) {
    if (msg.structure[type] === undefined || msg.structure[type] === null)
      return;
    ...
    ["dataSet", "series", "observation"].forEach(function(level) {
      ...
      if (
        msg.structure[type][level] === undefined ||
        msg.structure[type][level] === null
      )
        return;
...
lib.response.mapDataSetsToJsonStat = function(msg) {
  ...
  if (
    msg.structure.dimensions.dataSet !== undefined &&
    msg.structure.dimensions.dataSet !== null
  ) {
  ...
  if (
    msg.structure.dimensions.series !== undefined &&
    msg.structure.dimensions.series !== null
  ) {
  ...
  if (
    msg.structure.dimensions.observation !== undefined &&
    msg.structure.dimensions.observation !== null
  ) {
