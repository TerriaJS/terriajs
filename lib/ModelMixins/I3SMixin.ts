...
import I3STraits, { OptionsTraits } from "../Traits/TraitsClasses/I3STraits";
...
class I3SStratum extends LoadableStratum(I3STraits) {
...
StratumOrder.instance.addLoadStratum(I3SStratum.name);

const DEFAULT_HIGHLIGHT_COLOR = "#ff3f00";

interface I3SCatalogItemIface
  extends InstanceType<ReturnType<typeof I3SMixin>> {}

class ObservableCesium3DTileset extends Cesium3DTileset {
  _catalogItem?: I3SCatalogItemIface;
...
type BaseType = Model<I3STraits>;

function I3SMixin<T extends AbstractConstructor<BaseType>>(Base: T) {
  abstract class I3SMixin extends ClippingMixin(
    ...
    constructor(...args: any[]) {
      ...
      makeObservable(this);
      runInAction(() => {
        this.strata.set(I3SStratum.name, new I3SStratum());
      });
    }
    ...
    private loadTileset() {
      ...
      return Promise.resolve(resource).then((resource) => {
        ...
        // const tilesetPromise = ArcGISTiledElevationTerrainProvider.fromUrl(
        //   "https://tiles.arcgis.com/tiles/z2tnIkrLQ2BRzr6P/arcgis/rest/services/EGM2008/ImageServer"
        // ).then(geoidTiledTerrainProvider => I3SDataProvider.fromUrl(resource, { ...this.optionsObj, geoidTiledTerrainProvider  }));

        const tilesetPromise = I3SDataProvider.fromUrl(resource, {
          ...this.optionsObj,
          geoidTiledTerrainProvider: true
        ...
        return tilesetPromise.then((tileset) => {
          ...
          runInAction(() => {
            ...
            if (!observableTileset.destroyed) {
              ...
              console.log("i3 ts", this.tileset);
    ...
    @computed get cesiumTileStyle() {
      ...
      const ret = new Cesium3DTileStyle(style);
      return ret;
    }
    ...
    get highlightColor(): string {
      return this.highlightColor || DEFAULT_HIGHLIGHT_COLOR;
    }
  }
...
namespace I3SMixin {
  export interface Instance extends InstanceType<ReturnType<typeof I3SMixin>> {}
  export function isMixedInto(model: any): model is Instance {
    return model && model.hasCesium3dTilesMixin;
  }
}

export default I3SMixin;
