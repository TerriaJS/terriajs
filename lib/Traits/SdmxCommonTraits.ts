...
export class ConceptTraits extends DimensionTraits {
  ...
  @primitiveTrait({
    ...
    name: "Type",
    description:
      "Override concept/dimension type - Possible values are 'region' (values contain region codes used for region mapping - eg Country code) or 'region-type' (values contains region types - eg CNT2 2-letter country codes)"
  })
  type?: string;
