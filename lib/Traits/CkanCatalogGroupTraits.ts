...
export default class CkanCatalogGroupTraits extends mixTraits(
  ...
  @anyTrait({
    name: "Blacklist",
    description:
     `An array of strings of blacklisted groups names and data titles.
  ...
  @primitiveTrait({
    ...
    description: "Gets or sets a regular expression that, when it matches a resource's format, indicates that the resource is a GeoJSON resource"
  })
  ...
  @primitiveTrait({
    ...
    description: "Gets or sets a regular expression that, when it matches a resource's format, indicates that the resource is a WMS resource"
  })
  ...
  @primitiveTrait({
    ...
    description: "Gets or sets a regular expression that, when it matches a resource's format, indicates that the resource is a WFS resource"
  })
  ...
  @primitiveTrait({
    ...
    description: "Gets or sets a regular expression that, when it matches a resource's format, indicates that the resource is a KML resource"
  })
  ...
  @primitiveTrait({
    ...
    description: "Gets or sets a regular expression that, when it matches a resource's format, indicates that the resource is a CSV resource"
  })
  ...
  @primitiveTrait({
    ...
    description: "True to allow ArcGIS Map Server resources to be added to the catalog; otherwise, false."
  })
  ...
  @primitiveTrait({
    ...
    description: "True to allow ArcGIS Feature Server resources to be added to the catalog; otherwise, false."
  })
