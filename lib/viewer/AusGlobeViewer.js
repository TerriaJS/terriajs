...
var AusGlobeViewer = function(terria, options) {
    ...
    var useCesium = true;
    //set from loaded init sources
    var initMode = '3d';
    if (defined(terria.initialViewerMode)) {
        initMode = terria.initialViewerMode;
    }
    //override from url
    var useCesium = (initMode !== '2d' && terria.userProperties.map !== '2d' && params.map !== '2d');
