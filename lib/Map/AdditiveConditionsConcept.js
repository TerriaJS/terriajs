 ...
 */
AdditiveConditionsConcept.prototype.getOpenParentsBeforeLastParents = function() {
    return flattenNested(getNestedOpenParentsBeforeLastParents(this));
};
...
function getNestedOpenParentsBeforeLastParents(concept) {
    ...
    return concept.items.map(child => getNestedOpenParentsBeforeLastParents(child));
}
