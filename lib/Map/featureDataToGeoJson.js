...
// spatialReference is optional; defaults to featureData.geometry.spatialReference.
    ...
    if (defined(featureData.features)) {
        ...
        return {
            ...
            features: featureData.features.map(function(subFeatureData) {
                return getEsriGeometry(subFeatureData, geometryType, featureData.spatialReference);
            })
        };
    }
    var geoJsonFeature = {
        ...
        crs: esriSpatialReferenceToCrs(spatialReference || featureData.geometry.spatialReference)
    };
