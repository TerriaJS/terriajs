...
var CesiumTileLayer = L.TileLayer.extend({
    ...
    requestImage: function(tile, x, y, level) {
        ...
        function loadImageWithToken (url) {
            var loadPromise = that.loadImage(tile, url);
            ...
            return loadPromise.otherwise(function(requestErrorEvent) {
                ...
                // If we get here we have not been able to retrieve the tile successfully, but we don't want to do
                // anything since failure is the base case and the error URL will be loaded by default.
            });
        }
    ...
    loadImage: function(tile, url) {
        // TODO: This is the happy path implementation, todo come back and implement this properly.
    ...
    getTileUrl: function(tilePoint) {
        ...
        if (this.arcGisMapServerWithToken) {
            ...
            // which simplifies the error handling logic.
            return this.options.errorTileUrl;
        }
