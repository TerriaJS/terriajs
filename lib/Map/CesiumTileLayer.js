...
var CesiumTileLayer = L.TileLayer.extend({
    ...
    onRemove: function(map) {
        ...
        // Slightly hacky way to ensure that all pending tile requests are canceled.
        // This is really important when we're dragging the time slider and rapidly creating
        ...
        this._removeOtherTiles(L.bounds(L.point(-1,-1), L.point(-1,-1)));
    }
});
