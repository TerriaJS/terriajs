...
var DataTable = function(options) {
    ...
    knockout.defineProperty(this, 'displayVariablesConcept', {
        get : function() {
            var varNames = that.getVariableNamesByType([VarType.ALT, VarType.SCALAR, VarType.ENUM, VarType.TIME]);
            ...
            if (varNames.length > 0) {
                ...
                displayVariablesConcept.setSelected(that.getDataVariable(true));
            }
