...
var DataTable = function(options) {
    ...
    this.regionProviderList = (options ? options.regionProviderList : undefined);

    this.regionVariable = undefined;
    this.disambigVariable = undefined;
};
...
DataTable.prototype.loadJson = function (jsonTable) {
    ...
    // automatically set a data variable. May simplify life.
    this.selected.data = this.getDataVariableList(true)[0];
...
DataTable.prototype.checkForRegionVariable = function(regionProviderList) {
    ...
    if (r && defined(r.regionProvider)) {
        this.variables[r.regionVariable].setRegionType(r.regionProvider);
        this.regionVariable = r.regionVariable;
        this.disambigVariable = r.disambigVariable;
        this.regionProvider = r.regionProvider;
        return true;
    } else {
        this.regionVariable = undefined;
        this.disambigVariable = undefined;
