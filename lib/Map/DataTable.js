...
*/
DataTable.prototype.setDataVariable = function (variableConcept) {
    var varName = variableConcept.name;
    var makeActive = !variableConcept.isActive;
    ...
    if (defined(this.variables[varName])) {
        if (this.allowMultiple) {
            ...
            if (index === -1) {
                if (defined(this.chartCatalogGroup) && !defined(variableConcept.color)) {
                    variableConcept.color = this.chartCatalogGroup.getNextColor();
                }
