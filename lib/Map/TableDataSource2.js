...
var TableDataSource = function() {
    ...
    knockout.getObservable(this._tableStructure, 'activeItems').subscribe(function(activeItems) {
        ...
        updateEntitiesAndExtent(this, selectedColumn, this._tableStyle, legendHelper);
    }, this);
};
...
function updateEntitiesAndExtent(dataSource, tableColumn, tableStyle, legendHelper) {
