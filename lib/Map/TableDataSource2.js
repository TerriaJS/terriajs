...
* @constructor
* @param {Terria} [terria] The Terria instance. Used for its regionMappingDefinitionsUrl.
*/
var TableDataSource = function(terria) {
    this._name = name;
    ...
    this._regionMappingDefinitionsUrl = defined(terria) ? terria.regionMappingDefinitionsUrl : undefined;
    ...
    knockout.getObservable(this._tableStructure, 'activeItems').subscribe(function(activeItems) {
        ...
        var legendHelper = new LegendHelper(selectedColumn, this._tableStyle);
        this._legendUrl = legendHelper.legendUrl();
        updateEntitiesAndExtent(this, legendHelper);
    }, this);
};
    ...
    regionPromise: {
        get: function() {
            if (defined(this._region)) {
                // Return the cached region details.
...
function updateEntitiesAndExtent(dataSource, legendHelper) {
