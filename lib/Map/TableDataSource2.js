...
var TableDataSource = function() {
    ...
    knockout.track(this, ['_tableStructure']);  // track the tableStructure so that concepts can be maintained
};
...
TableDataSource.prototype.load = function(csvString, tableStyle) {
    ...
    updateEntitiesAndExtent(this, selectedColumn, tableStyle, this._legend);
};
