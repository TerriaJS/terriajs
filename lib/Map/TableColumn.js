...
* @param {Boolean} [options.noFinishDates] If true, then finishDates, availabilities and clock are not calculated (even if this is a time column).
*/
var TableColumn = function(name, values, options) {
    ...
    // Track values so that charts can update live with new data.
    knockout.track(this, ['_type', '_values']);
};
