...
var TableColumn = function(name, values, options) {
    ...
    /**
     * A {@link TimeInteralCollection} indicating the times for which at least one row has data.
     * @type {TimeIntervalCollection}
     */
    this._availabilityIntervals = undefined;
    /**
...
defineProperties(TableColumn.prototype, {
    ...
    availabilityIntervals: {
        get: function() {
            return this._availabilityIntervals;
        }
    },
