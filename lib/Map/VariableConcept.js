...
VariableConcept.prototype.toggleActive = function() {
    ...
    if(defined(this.parent.disableIncompatibleTableColumns && typeof this.parent.disableIncompatibleTableColumns === 'function')){
        this.parent.disableIncompatibleTableColumns(this);
    }
