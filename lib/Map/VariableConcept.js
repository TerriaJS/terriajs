...
VariableConcept.prototype.toggleActive = function() {
    ...
    if(defined(this.parent.disableIncompatibleTableColumnsCallback && typeof this.parent.disableIncompatibleTableColumnsCallback === 'function')){
        this.parent.disableIncompatibleTableColumnsCallback(this);
    }
