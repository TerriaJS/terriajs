 ...
 * @param {Boolean} [options.useChooser] Whether this concept should be de/activated using the conceptChooser.
 */
var VariableConcept = function(name, options) {
     ...
     * @type {Boolean}
     */
    this.useChooser = defaultValue(options.useChooser, false);
