 ...
 */
    ...
    // Map from future RegionProvider type name to a promise that'll resolve with the RegionProvider
    // @type {{[key: string]: Promise<RegionProvider>}}
    this.geoJsonProviderPromises = {};
