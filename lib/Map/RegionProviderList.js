...
*  Implements most of https://github.com/NICTA/nationalmap/wiki/csv-geo-au
*  How this works:
 ...
 * @param {Object} obj
 */
RegionProviderList.prototype.initFromObject = function(obj, corsProxy) {
    var that = this;
    Object.keys(obj.regionWmsMap).forEach(function(r) {
        that.regionProviders.push(new RegionProvider(r, obj.regionWmsMap[r], corsProxy));
    });
