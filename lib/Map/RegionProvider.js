...
/**
 * Gets a list of indices into this.region.
 * Eg. If regionArray = ['Vic', 'Qld', 'NSW'], and this.regions = ['NSW', 'Vic', 'Qld'], then returns [2, 3, 1].
 *
 ...
 */
RegionProvider.prototype.getRegionIndices = function(regionValues, disambigValues) {
