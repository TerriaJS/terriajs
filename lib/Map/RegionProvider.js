...
RegionProvider.prototype.findRegionIndex = function(code, disambigCode) {
    var processedCode = (typeof code === 'string' ? this.applyReplacements(code.toLowerCase(), "dataReplacements") : String(code));
    var processedDisambigCode = (typeof disambigCode === 'string' ? this.applyReplacements(disambigCode, "disambigDataReplacements").toLowerCase() : disambigCode);
