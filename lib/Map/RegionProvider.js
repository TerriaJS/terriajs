...
var RegionProvider = function(regionType, properties, corsProxy) {
  ...
  /**
   * URL of the WMS or MVT server, or the tile index returned by geojson-vt when using GeoJSON region mapping
   * @type {String | Object}
   */
...
RegionProvider.prototype.loadRegionIDs = function() {
  ...
  function fetchAndProcess(idListFile, idProp, propertyName, replacementsVar) {
    ...
    p.then(function(json) {
      RegionProvider.processRegionIds(
        that,
        json.values,
        propertyName,
        replacementsVar
 ...
 */
RegionProvider.processRegionIds = function processRegionIds(
  regionProvider,
  values,
  propertyName,
  replacementsProp
