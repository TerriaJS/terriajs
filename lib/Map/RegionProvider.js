...
var RegionProvider = function(regionType, properties) {
    ...
    */
    ...
    /**
     * JSON file for disambiguation attribute, as per regionIdList.
     * @type {String}
     */
    this.regionDisambigIdList = properties.regionDisambigIdList;
...
RegionProvider.prototype.loadRegionIDs = function() {
    ...
    var promises = [
        fetchAndProcess(this.regionIdList, this.regionProp, undefined, 'serverReplacements'),
        fetchAndProcess(this.regionDisambigIdList, this.disambigProp, this.disambigProp, 'disambigServerReplacements')];
