...
var RegionProvider = function(regionType, properties) {
    ...
    */
    ...
    /**
    * URL and config related to the WMS or  Mapbox/Mapnik vector tile server
    * @type {Object|String}
    */
    this.server = properties.server;

    /**
    * Server type (either 'vector' or 'WMS')
    * @type {String}
    */
    this.serverType = properties.serverType;

    if (this.serverType === 'vector') {
        /**
        * Bounding box of vector geometry
        * @type {Number[]}
        */
