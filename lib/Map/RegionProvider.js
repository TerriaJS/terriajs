...
RegionProvider.prototype.loadRegionIDs = function() {
    ...
    function fetchAndProcess(idListFile, idProp, propertyName, replacementsVar) {
        ...
        p.then(function(json) {
            RegionProvider.processRegionIds(that, json.values, propertyName, replacementsVar);
 ...
 */
RegionProvider.processRegionIds = function processRegionIds(regionProvider, values, propertyName, replacementsProp) {
