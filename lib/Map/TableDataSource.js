...
defineProperties(TableDataSource.prototype, {
       ...
       isLoading : {
         ...
         /**
         * Gets an CesiumEvent that will be raised when the underlying data changes.
         * @memberof TableDataSource.prototype
         * @type {CesiumEvent}
         */
       changedCesiumEvent : {
         ...
         /**
         * Gets an CesiumEvent that will be raised if an error is encountered during processing.
         * @memberof TableDataSource.prototype
         * @type {CesiumEvent}
         */
       errorCesiumEvent : {
        ...
        /**
         * Gets an CesiumEvent that will be raised when the data source either starts or stops loading.
         * @memberof TableDataSource.prototype
         * @type {CesiumEvent}
         */
        loadingCesiumEvent : {
...
TableDataSource.prototype.setDisplayStyle = function (style) {
    ...
    // We used did this regardless to force rebuild of czml datasource - no need now it's internal
...
TableDataSource.prototype.setDataVariable = function (varName) {
    ...
    if (this.dataset.hasLocationData()) {
        ...
        for (var i = 0; i < pointList.length; i++) {
            ...
            addEntityFromPoint(this, pointList[i], name, dataRow);
        }
...
function addEntityFromPoint(dataSource, point, name, properties) {
    ...
    var color = dataSource._mapValue2Color(point.val);
    ...
    if (dataSource.dataset.hasTimeData()) {
        ...
        var availabilityInterval = new TimeInterval({start: JulianDate.toIso8601(start), stop: JulianDate.toIso8601(finish), data: true});
        ...
        show.intervals.addInterval(availabilityInterval);  // depends on the data: true above - TODO: is that right for availability though?
    }
    else {
