...
TableDataSource.prototype.getLegendGraphic = function () {
    ...
    function drawColorMap(ctx, height, width, top, left, binColors) {
        ...
        for (var i = 0; i < bins; i++) {
            ...
            ctx.fillRect(left, top + height - binHeight * i, width, binHeight);
    ...
    if (this._binColors) {
        drawColorMap(ctx, gradH, gradW, 5, 15, this._binColors);
    } else {
