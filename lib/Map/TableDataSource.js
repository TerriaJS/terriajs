...
var TableDataSource = function () {
    ...
    this.imageUrl = '';
    this.displayTime = undefined;  //minutes
...
TableDataSource.prototype.loadText = function (text) {
    ...
    if (this.dataset && this.dataset.hasTimeData() && !defined(this.displayTime)) {
...
TableDataSource.prototype.getLegendGraphic = function () {
    ...
    var l, ht, segmentCount = 5;
    for (l = 1; l < segmentCount; l++) {
        ht = gradH * l / segmentCount;
        ctx.beginPath();
        ctx.moveTo(0, ht);
        ctx.lineTo(gradW, ht);
        ctx.stroke();
...
//    ctx.textAlign = 'right';
    ...
    if (defined(minVal) && defined(maxVal)) {
        for (l = 1; l < segmentCount; l++) {
            ht = gradH * l / segmentCount;
            val = minVal + (maxVal - minVal) * (segmentCount-l) / segmentCount;
