...
function chooseAndActivateAColumn(tableStructure) {
    ...
    var columnsByType = tableStructure.columnsByType;
...
function setNewRegionImageryLayer(dataSource, layerIndex) {
    ...
    if (defined(tableStructure.activeItems[0])) {
        ...
        var regionValues = regionIndices.map(function(i) { return tableStructure.activeItems[0].values[i]; });
    ...
    // TODO: This stopped working on leaflet somewhere along the way!
