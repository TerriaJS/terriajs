...
/**
 * Calculate and return the availability interval for the index'th entry in timeColumn, or undefined if no timeColumn.
 *
...
function updateEntitiesAndExtent(dataSource) {
    ...
    if (defined(longitudeColumn) && defined(latitudeColumn)) {
        ...
        for (var i = 0; i < rowObjects.length; i++) {
            ...
            entity.availability = calculateAvailability(i, timeColumn, tableStyle);
