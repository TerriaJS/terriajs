 ...
 * @param {String} [style.displayDuration] A string representing an image to display for the point. 
 ...
 * @param {Integer} [style.minDisplayValue] Set the number of segements in the colormap. 
 *
 */
TableDataSource.prototype.setDisplayStyle = function (style) {
    ...
    this.displayDuration = style.displayDuration || this.displayDuration;
    ...
    this.legendSegments = style.legendSegments || this.legendSegments;
...
TableDataSource.prototype.getDisplayStyle = function () {
    ...
    return {
        ...
        legendSegments: this.legendSegments,
...
TableDataSource.prototype.getLegendGraphic = function () {
    ...
    var s, ht;
    var segments = this.legendSegments;
