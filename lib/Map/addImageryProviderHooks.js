...
ImageryHooks.addRecolorFunc = function(imageryProvider, recolorFunc) {
...
ImageryHooks.recolorImage = function(image, colorFunc) {
...
function recolorImageWithCanvasContext(context, img, colorFunc) {
    ...
    image = ImageryHooks.recolorImage(image, colorFunc);
    return image;
}


ImageryHooks.addPickFeaturesHook = function(imageryProvider, hook) {
