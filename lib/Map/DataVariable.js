...
DataVariable.prototype._processEnumVariable = function () {
    ...
    for (var i = 0; i < this.vals.length; i++) {
        ...
        if (!defined(n)) {
            n = enumList.length;
            enumList.push(String(this.vals[i])); // ## is making enums always strings a bad idea?
...
DataVariable.prototype.setRegionType = function(regionProvider) {
    this.varType = VarType.REGION;
    this.regionProvider = regionProvider;
};

DataVariable.prototype.getRegionType = function(regionProvider) {
