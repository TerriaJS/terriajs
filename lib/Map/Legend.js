...
var Legend = function(props) {
    ...
    this.width = defaultValue(props.width, longestTitle(this) > 20 ? 300 : 210) ; // total width
...
function drawItemBoxes(legend, ctx) {
    legend.items.forEach(function(item, i) {
        ...
        var itemTop = legend.barTop + (legend.itemHeight + legend.itemSpacing) * (legend.items.length - i - 1);
