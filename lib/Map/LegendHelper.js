...
/**
 * Generates and saves the legend. This could be exposed in an API if needed.
 */
function generateLegend(legendHelper) {
    ...
    var colorMap = defaultValue(legendHelper.tableStyle.colorMap, defaultColorMap);
 ...
 * @param  {Number} [value] The absolute value.
 * @return {Number[]} The color. If no value is provided, uses a default color.
 */
