...
function generateLegend(legendHelper) {
    ...
    // TODO: not quite sure where tableStyle.colorPalette fits in here
    var colorMap;
    if (!defined(legendHelper.tableStyle.colorMap)) {
        if (legendHelper.tableColumn.type === VarType.ENUM) {
            ...
            colorMap = ColorMap.fromArray(defaultEnumColorCodes.slice(0, legendHelper.tableStyle.colorBins));
        } else {
