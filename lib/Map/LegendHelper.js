...
var LegendUrl = require('../Models/LegendUrl');  // TODO: must move legendHelper or legendUrl, as Map cannot refer to Models
    ...
    if (!binColors) {
        ...
        return {
            ...
            items: reversedBinColors.map(function(bin, index) {
                return {
                    title: tableColumn.uniqueValues[reversedBinColors.length - 1 - index],  // Get the right label, noting the bin colors are reversed.
