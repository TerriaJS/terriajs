 ...
 * @param  {Number} [value] The absolute value.
 * @return {Number[]} The color, as an array [r, g, b, a]. If no value is provided, or no color bins are defined, uses the nullColor.
 */
LegendHelper.prototype.getColorArrayFromValue = function(value) {
    if (!definedNotNull(value) || !defined(this._binColors) || (this._binColors.length === 0)) {
