 ...
 * @param {VariableConcept} [concept] The concept to make active/inactive. If none provided, deactivates all.
 */
DisplayVariablesConcept.prototype.toggleActiveItem = function(concept) {
    if (!defined(concept)) {
        // If concept is not provided, deactivate all children and return.
