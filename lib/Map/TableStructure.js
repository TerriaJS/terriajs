        ...
        set: function(nameIdOrIndex) {
            ...
            if (defined(nameIdOrIndex)) {
                ...
                if (defined(timeColumnToActivate) && (!defined(timeColumnToActivate.finishJulianDates))) {
                    ...
                    if (timeColumnToActivate._timeIntervals) {
                        timeColumnToActivate._availabilityIntervals = timeColumnToActivate._timeIntervals.reduce(function(intervals, interval) {
                            if (defined(interval)) {
                        ...
                        timeColumnToActivate._availabilityIntervals = new TimeIntervalCollection();
                    }
                } else {
                    this._activeTimeColumnNameIdOrIndex = undefined;
                }
