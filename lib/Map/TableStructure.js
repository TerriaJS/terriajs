        ...
        set: function(nameIdOrIndex) {
            ...
            if (defined(nameIdOrIndex)) {
                ...
                if (defined(timeColumnToActivate) && (!defined(timeColumnToActivate.finishJulianDates))) {
                    ...
                    timeColumnToActivate.finishJulianDates = calculateFinishDates(sortedColumns, nameIdOrIndex, this.idColumnNames);
...
function calculateFinishDates(columns, nameIdOrIndex, idColumnNames) {
