...
var TableStructure = function(name, options) {
    ...
    DisplayVariablesConcept.call(this, name, {getColorCallback: options.getColorCallback});
...
function getColumnOptions(name, tableStructure, columnNumber) {
    ...
    var colOptions = {
        ...
        axisMin: columnOptions.axisMin,
        axisMax: columnOptions.axisMax
    };
