...
function combineRepeatedInPlace(sortedValueArrays, firstColumnType) {
    if (firstColumnType === VarType.TIME) {
        ...
        var julianDates = TableColumn.convertToDates(sortedValueArrays[0]).julianDates;
        sortedValueArrays[0] = julianDates.map(function(jdate) { return JulianDate.toIso8601(jdate); });
    }
