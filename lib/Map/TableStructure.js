...
defineProperties(TableStructure.prototype, {
    ...
    timeIntervals: {
        get: function() {
            ...
            if (!defined(this._timeIntervals)) {
                this._timeIntervals = calculateTimeIntervals(this);
            }
...
/**
 * A Table might have dates 2015-03-01, 2015-04-01
 * @param  {[type]} tableStructure [description]
 * @return {[type]}                [description]
 * @private
 */
function calculateNaturalPeriodLength(tableStructure) {
...
function calculateFinishDates(tableStructure) {
    var originalJulianDates = tableStructure.activeTimeColumn.julianDates;
