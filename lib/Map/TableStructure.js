    ...
    activeTimeColumnNameIdOrIndex: {
        ...
        set: function(nameIdOrIndex) {
            ...
            if (defined(nameIdOrIndex)) {
                ...
                var timeColumnToActivate = this.getColumnWithNameIdOrIndex(valueOrFirstValue(nameIdOrIndex), sortedColumns);
                if (defined(timeColumnToActivate) && (!defined(timeColumnToActivate.finishJulianDates))) {
                    ...
                    timeColumnToActivate.finishJulianDates = calculateFinishDates(this, timeColumnToActivate);
...
* @returns {TableColumn} The matching column.
*/
TableStructure.prototype.getColumnWithNameOrId = function(nameOrId, columns) {
    if (!defined(columns)) {
        columns = this.columns;
    }
    for (var i = 0; i < columns.length; i++) {
...
* @returns {TableColumn} The matching column.
*/
TableStructure.prototype.getColumnWithNameIdOrIndex = function(nameIdOrIndex, columns) {
    if (nameIdOrIndex === null) {
        return undefined;
    }
    if (isInteger(nameIdOrIndex)) {
        return defined(columns) ? columns[nameIdOrIndex] : this.columns[nameIdOrIndex];
    }
    return this.getColumnWithNameOrId(nameIdOrIndex, columns);
};
