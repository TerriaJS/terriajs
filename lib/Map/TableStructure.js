 ...
 */
TableStructure.prototype.updateWithColumnValues = function(updatedColumnValuesArrays) {
    ...
    this.activeTimeColumnNameIdOrIndex = this.activeTimeColumnNameIdOrIndex;  // Triggers sorting side-effect if defined.
};
...
TableStructure.prototype.append = function(table2, rowNumbers) {
    ...
    this.updateWithColumnValues(updatedColumnValuesArrays);
};
...
/**
 * Mutates the table structure so it includes rows for all features at the full table's start and end dates,
 ...
 * @param {[type]} valueColumnNameIdOrIndex Name, id or index of the column which should be set to null at the table's start and end dates.
 */
TableStructure.prototype.addFeatureRowsAtStartAndEndDates = function(valueColumnNameIdOrIndex) {
    ...
    tableStructure.updateWithColumnValues(copiedColumnValues);
};
