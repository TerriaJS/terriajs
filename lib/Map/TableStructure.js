 ...
 *                (see CsvCatalogItem.idColumns). This is not currently used by TableStructure/Column.
 */
var TableStructure = function(name, options) {
    ...
    this.idColumnNames = options.idColumnNames;  // note actually names/ids/indexes
