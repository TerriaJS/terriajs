...
/**
 * Instantiate an address converter.
 *
 * @alias GnafAddressConverter
 * @constructor
 * @extends AddressConverter
 *
 */
var GnafAddressConverter = function() {
    AddressConverter.call(this);
};
 ...
 */
GnafAddressConverter.prototype.bulkConvertAddresses = function(tableStructure, corsProxy) {
    ...
    return gnafApi.bulkGeoCode(addressesPlusInd.addresses, undefined).then(function(info) {
        ...
        that.missingAddresses = missingAddresses;
        return when(true);
...
module.exports = GnafAddressConverter;
