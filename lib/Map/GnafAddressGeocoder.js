...
var AddressGeocoderData = require('../Map/AddressGeocoderData');
 ...
 * @return {Promise} Promise that resolves to an AddressGeocoderData object.
 */
GnafAddressGeocoder.prototype.bulkConvertAddresses = function(tableStructure, corsProxy) {
    ...
    return gnafApi.bulkGeoCode(addressesPlusInd.addresses, undefined).then(function(info) {
        ...
        var addressGeocoderData = new AddressGeocoderData(that.startTime,
