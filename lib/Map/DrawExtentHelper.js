...
const CallbackProperty = require("terriajs-cesium/Source/DataSources/CallbackProperty")
  .default;
const CesiumMath = require("terriajs-cesium/Source/Core/Math").default;
const Color = require("terriajs-cesium/Source/Core/Color").default;
...
const KeyboardEventModifier = require("terriajs-cesium/Source/Core/KeyboardEventModifier")
  .default;
const Rectangle = require("terriajs-cesium/Source/Core/Rectangle").default;
const ScreenSpaceEventHandler = require("terriajs-cesium/Source/Core/ScreenSpaceEventHandler")
  .default;
const ScreenSpaceEventType = require("terriajs-cesium/Source/Core/ScreenSpaceEventType")
  .default;
const DrawExtentHelperModel = require("./DrawExtentHelperModel").default;
...
DrawExtentHelper.prototype.handleRegionStop = function(movement) {
  if (defined(this._model)) {
    this._terria.overlays.remove(this._model);
    this._terria.removeModelReferences(this._model);
    this._model = undefined;
  }
...
DrawExtentHelper.prototype.handleRegionStart = function(movement) {
  ...
  if (cartesian) {
    ...
    if (!defined(this._dataSource)) {
      ...
      const model = new DrawExtentHelperModel(this._terria, dataSource);
      this._terria.addModel(model);
      this._terria.overlays.add(model);
