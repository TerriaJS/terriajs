...
var UserPoint = function(cesium, terria) {
...
style: { "top" : _screenPositionY, "left" : _screenPositionX, transform: transform, opacity: opacity }');
    ...
    this._userPointElement = el;

    var img = document.createElement('img');
    img.setAttribute('src', this._cesium.terria.baseUrl + 'images/selected-point.svg');
    img.setAttribute('alt', '');
    img.setAttribute('width', 15);
    img.setAttribute('height', 15);
    el.appendChild(img);

    knockout.applyBindings(this, this._userPointElement);
};

UserPoint.prototype.destroy = function() {
    this._userPointElement.parentNode.removeChild(this._userPointElement);
};

UserPoint.prototype.update = function() {
    if (this.showSelection && defined(this.position)) {
        ...
        if (!defined(screenPosition)) {
            ...
            var indicatorSize = this._userPointElement.clientWidth;
 ...
 */
UserPoint.prototype.animateAppear = function() {
 ...
 */
UserPoint.prototype.animateDepart = function() {
    if (defined(this._selectionIndicatorTween)) {
        if (!this._selectionIndicatorIsAppearing) {
...
defineProperties(UserPoint.prototype, {
    /**
     * Gets the HTML element containing the selection indicator.
     * @memberof UserPoint.prototype
     *
     * @type {Element}
     */
    container : {
 ...
 * @callback UserPoint~ComputeScreenSpacePosition
