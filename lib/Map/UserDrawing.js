 ...
 * @param {Bool}   [options.allowPolygon] Let the user click on first point to close loop.
...
var UserDrawing = function(terria, options) {
    ...
    /**
     * If true, the user can click on the first point to close the line into a polygon.
     * @type {Bool}
     * @default true
     */
