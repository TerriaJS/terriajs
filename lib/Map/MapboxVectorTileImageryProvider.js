...
getCachedFeature.lrucache = LRU({
    ...
    length: geom_length, // Sum of ring lengths
    dispose: function(key, geom) { console.log(key, geom_length(geom, key)); }, // Print size on delete
...
MapboxVectorTileImageryProvider.prototype._requestImage = function(x, y, level, canvas) {
    ...
    return loadArrayBuffer(url).then(function(data) {
        ...
        for (var i = 0; i < layer.length; i++) {
            var feature = getCachedFeature(layer.feature(i), url + ':' + i);
