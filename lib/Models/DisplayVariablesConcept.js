 ...
 * @param {Boolean} [allowMultiple=false] Set to true if more than one checkbox can be selected at a time.
 */
...
DisplayVariablesConcept.prototype.setSelected = function(selectedVariables) {
    for (var i = selectedVariables.length - 1; i >= 0; i--) {
        var selectedVariable = selectedVariables[i];
