...
RegionParameter.prototype.findRegionByID = function(regionID, parameterValues) {
    ...
    if (typeof regionID === 'string' && regions.regions[0] && typeof regions.regions[0].id === 'number') {
        regionID = parseInt(regionID, 10);
    } else {
        var replacedValue = regions._appliedReplacements.serverReplacements[regionID.toLowerCase()];
