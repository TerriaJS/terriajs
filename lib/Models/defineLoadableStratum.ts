 ...
 */
export default function defineLoadableStratum<TDefinition>(definition: DefinitionConstructor<TDefinition>) : LoadableStratumConstructor<TDefinition>;
export default function defineLoadableStratum<TDefinition, T1 extends keyof TDefinition>(definition: DefinitionConstructor<TDefinition>, property1: T1): LoadableStratumConstructor<Pick<TDefinition, T1>>;
export default function defineLoadableStratum<TDefinition, T1 extends keyof TDefinition, T2 extends keyof TDefinition>(definition: DefinitionConstructor<TDefinition>, property1: T1, property2: T2): LoadableStratumConstructor<Pick<TDefinition, T1 | T2>>;
export default function defineLoadableStratum<TDefinition, T1 extends keyof TDefinition, T2 extends keyof TDefinition, T3 extends keyof TDefinition>(definition: DefinitionConstructor<TDefinition>, property1: T1, property2: T2, property3: T3): LoadableStratumConstructor<Pick<TDefinition, T1 | T2 | T3>>;
export default function defineLoadableStratum<TDefinition, T1 extends keyof TDefinition, T2 extends keyof TDefinition, T3 extends keyof TDefinition, T4 extends keyof TDefinition>(definition: DefinitionConstructor<TDefinition>, property1: T1, property2: T2, property3: T3, property4: T4): LoadableStratumConstructor<Pick<TDefinition, T1 | T2 | T3 | T4>>;
...
export default function defineLoadableStratum<TDefinition>(definition: DefinitionConstructor<TDefinition>, ...properties: string[]): LoadableStratumConstructor<any> {
