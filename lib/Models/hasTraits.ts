 ...
 */
function hasTraits<TTraits extends ModelTraits, K1 extends keyof TTraits>(model: any, TraitsClass: TraitsConstructor<TTraits>, trait1: K1): model is HasTrait<TTraits, K1>;
function hasTraits<TTraits extends ModelTraits, K1 extends keyof TTraits, K2 extends keyof TTraits>(model: any, TraitsClass: TraitsConstructor<TTraits>, trait1: K1, trait2: K2): model is HasTrait<TTraits, K1> & HasTrait<TTraits, K2>;
function hasTraits<TTraits extends ModelTraits, K1 extends keyof TTraits, K2 extends keyof TTraits, K3 extends keyof TTraits>(model: any, TraitsClass: TraitsConstructor<TTraits>, trait1: K1, trait2: K2, trait3: K3): model is HasTrait<TTraits, K1> & HasTrait<TTraits, K2> & HasTrait<TTraits, K3>;
function hasTraits<TTraits extends ModelTraits, K1 extends keyof TTraits, K2 extends keyof TTraits, K3 extends keyof TTraits, K4 extends keyof TTraits>(model: any, TraitsClass: TraitsConstructor<TTraits>, trait1: K1, trait2: K2, trait3: K3, trait4: K4): model is HasTrait<TTraits, K1> & HasTrait<TTraits, K2> & HasTrait<TTraits, K3> & HasTrait<TTraits, K4>;
function hasTraits<TTraits extends ModelTraits, K1 extends keyof TTraits, K2 extends keyof TTraits, K3 extends keyof TTraits, K4 extends keyof TTraits, K5 extends keyof TTraits>(model: any, TraitsClass: TraitsConstructor<TTraits>, trait1: K1, trait2: K2, trait3: K3, trait4: K4, trait5: K5): model is HasTrait<TTraits, K1> & HasTrait<TTraits, K2> & HasTrait<TTraits, K3> & HasTrait<TTraits, K4> & HasTrait<TTraits, K5>;
function hasTraits(model: any, TraitsClass: TraitsConstructor<ModelTraits>, ...traits: string[]): boolean {
