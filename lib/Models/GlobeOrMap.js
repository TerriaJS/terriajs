...
/**
 * Gets a bounding box of what's currently in view, in the format {topLeft: {latitude, longitude}, bottomRight: {latitude, longitude}}
 * with latitude/longitude in degrees.
 */
GlobeOrMap.prototype.getBoundingBoxCoords = function() {
    throw new DeveloperError('getBoundingBoxCoords must be implemented in the derived class.');
};
