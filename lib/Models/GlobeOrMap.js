...
var GlobeOrMap = function(terria) {
    ...
    /**
     * Gets or sets whether to show a splitter. This property is observable.
     * @type {Boolean}
     */
    ...
    knockout.track(this, ['showSplitter']);
};
...
/**
 * If a splitter can be shown on this viewer, define a function to toggle it on and off here.
 */
GlobeOrMap.prototype.toggleSplitter = undefined;
