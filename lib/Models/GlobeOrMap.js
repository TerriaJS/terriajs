...
var GlobeOrMap = function(terria, disclaimerClass) {
    ...
    this._disclaimerShiftSubscription = knockout.getObservable(this.terria.commonViewerProps, 'shiftDisclaimerPx').subscribe(this._shiftDisclaimers, this);

    this._shiftDisclaimers(this.terria.commonViewerProps.shiftDisclaimersPx);
};
