    ...
    if (defined(feature)) {
        ...
        if (!hasGeometry) {
            if (feature.imageryLayer && feature.imageryLayer.imageryProvider instanceof MapboxVectorTileImageryProvider) {
                this._removeHighlightCallback = this.terria.currentViewer.addVectorTileFeatureHighlight(feature);
            } else {
...
GlobeOrMap.prototype.addVectorTileFeatureHighlight = function(feature) {
    return function() {};
};
