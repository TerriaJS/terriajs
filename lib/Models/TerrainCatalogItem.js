...
TerrainCatalogItem.defaultUpdaters.supportsSplitting = function(
  catalogItem,
  json,
  propertyName
) {
...
TerrainCatalogItem.defaultUpdaters.splitDirection = function(
  catalogItem,
  json,
  propertyName
) {
...
TerrainCatalogItem.defaultPropertiesForSharing = clone(
