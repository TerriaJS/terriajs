...
/**
 * Gets or sets the default set of properties that are serialized when serializing a {@link BillboardCatalogItem}-derived object with the
 * `serializeForSharing` flag set in the options.
 * @type {String[]}
 */
BillboardCatalogItem.defaultPropertiesForSharing = clone(BillboardCatalogItem.defaultPropertiesForSharing);
