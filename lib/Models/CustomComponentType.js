...
const CustomComponentType = function(options) {
     ...
     * @param {CatalogMember} catalogItem The catalog item for which this chart is being requested.
     * @param {Entity} feature The feature for which this chart is being requested.
