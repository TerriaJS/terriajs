...
var CustomComponentType = function(options) {
    ...
    /**
     * Gets or sets a function which is called when an instance of this custom component is created.
     ...
     * @param CustomComponentInstance The custom component instance being rendered.
     */

    /**
     * A function that is called when an instance of this custom component is created.
     * @callback CustomComponentType~customSetup
     * @param CustomComponentInstance The custom component instance being set up.
     */
