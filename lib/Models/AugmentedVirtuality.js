...
AugmentedVirtuality.prototype.hover = function(height, position) {
    ...
    if ((!defined(this._terria.cesium) ||
        ...
        // If we can't get access to the terrain provider or we can get access to the terrain provider and the provider is just the Ellipsoid then set the height to 0.
        flyToHeight(0);
    } else {
