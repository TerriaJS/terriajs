...
/**
 * Sets the minimum height that the viewer is allowed to hover at.
 */
 ...
 */
AugmentedVirtuality.prototype.moveTo = function(position) {
    const that = this;
    ...
    let moveToLocation = function(surfaceHeight) {
        ...
        that.hover(viewerHeight - surfaceHeight, position);
    };
