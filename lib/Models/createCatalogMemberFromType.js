...
var createCatalogMemberFromType = function(type, terria) {
  ...
  if (!defined(Constructor)) {
    throw new TerriaError({
      ...
      message:
        "\
Unknown catalogue item type: " +
        type +
        ".  If you are loading your own catalogue, please verify that it is correct. \
This error may also indicate an attempt to load a newer catalogue file in an older version of " +
        terria.appName +
        "."
    });
  }
