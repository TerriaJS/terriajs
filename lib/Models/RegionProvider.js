 ...
 */
RegionProvider.prototype.findRegionIndex = function(code, disambigCode) { //, ids, rd, row) {
...
RegionProvider.prototype._getDisambigProvider = function() {
    if (!defined(this.disambigColumns) || this.disambigColumns.length < 1) {
        return undefined;
    }
...
RegionProvider.prototype.findDisambigVariable = function(variables) {
    ...
    return (dabp ? variables[dabp.findRegionVariable(variables)].name : undefined);
};
