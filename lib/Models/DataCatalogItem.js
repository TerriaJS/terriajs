...
/**
 * A {@link CatalogItem} representing possibly-non-geospatial data.
 *
 ...
 */
var DataCatalogItem = function(terria, url, column) {
    CatalogItem.call(this, terria);

    this._dataset = new DataTable();

    this._clockTickUnsubscribe = undefined;

    this._regionMapped = false;

    this._type = 'csv'; // TODO: for now
    this._typeName = 'Comma-Separated Values (CSV)';
...
defineProperties(DataCatalogItem.prototype, {
     ...
     * @type {Metadata}
     */
    metadata : {  //TODO: return metadata if defined
        get : function() {
...
DataCatalogItem.defaultSerializers.legendUrl = function() {
