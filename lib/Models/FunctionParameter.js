...
/**
 * Returns a GeoJSON feature that represents value, if it makes sense to do so.
 * @param {Object} value Value to get GeoJSON feature for.
 * @return {Object} JSON feature or undefined.
 */
FunctionParameter.prototype.getGeoJsonFeature = function(value) {
    return undefined;
};
