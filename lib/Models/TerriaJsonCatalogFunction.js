...
TerriaJsonCatalogFunction.prototype.invoke = function() {
  ...
  this.parameters.forEach(parameter => {
    ...
    // first working prototype and would appreciate feedback.
    if (parameter.type.endsWith('-group') && ('groupIsTransparent' in parameter.availableFormatters)) {
        parameter.formatForService().forEach(function(value) { 
          queryParameters[Object.keys(value)] = value[Object.keys(value)];
        });
    } else {
