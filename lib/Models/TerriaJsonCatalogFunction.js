...
/**
 * A {@link CatalogFunction} that does an HTTP GET to a service with a set of query parameters specified by the
 * {@link TerriaJsonCatalogFunction#inputs} property and configured through an automatically-generated user
 * interface in the catalog. The service is expected to return TerriaJS catalog/share JSON which can add items
