    ...
    if (defined(longitudeColumn) && defined(latitudeColumn)) {
        ...
        for (var i = 0; i < rowObjects.length; i++) {
            ...
            if (!dataSource._isUpdating) {
                ...
                entity.description = new CallbackProperty(getRowDescriptionPropertyCallbackForRow(i), false);
                if (entity.propertyNames.indexOf('properties') === -1) {
                    entity.addProperty('properties');  // Not defined yet, but could be in future.
                }
                entity.properties = new CallbackProperty(getRowPropertiesPropertyCallbackForRow(i), false);
            }
