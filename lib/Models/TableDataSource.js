...
var CallbackProperty = require("terriajs-cesium/Source/DataSources/CallbackProperty").default;
...
var defineProperties = require("terriajs-cesium/Source/Core/defineProperties").default;
...
var EntityCollection = require("terriajs-cesium/Source/DataSources/EntityCollection").default;
var EntityCluster = require("terriajs-cesium/Source/DataSources/EntityCluster").default;
var CesiumEvent = require("terriajs-cesium/Source/Core/Event").default;
var knockout = require("terriajs-cesium/Source/ThirdParty/knockout").default;
var HorizontalOrigin = require("terriajs-cesium/Source/Scene/HorizontalOrigin").default;
var Iso8601 = require("terriajs-cesium/Source/Core/Iso8601").default;
var Rectangle = require("terriajs-cesium/Source/Core/Rectangle").default;
var SampledPositionProperty = require("terriajs-cesium/Source/DataSources/SampledPositionProperty").default;
var SampledProperty = require("terriajs-cesium/Source/DataSources/SampledProperty").default;
...
var TimeIntervalCollectionPositionProperty = require("terriajs-cesium/Source/DataSources/TimeIntervalCollectionPositionProperty").default;
var TimeIntervalCollectionProperty = require("terriajs-cesium/Source/DataSources/TimeIntervalCollectionProperty").default;
var VerticalOrigin = require("terriajs-cesium/Source/Scene/VerticalOrigin").default;

var Feature = require("./Feature");
var LegendHelper = require("./LegendHelper");
      ...
      if (!nanErrorDisplayed) {
        ...
        dataSource._terria.error.raiseEvent(
          new TerriaError({
            ...
            message: `Could not interpret latitude and longitude pair ${
              specialColumns.longitude.values[i]
            },${specialColumns.latitude.values[i]}`
          })
        );
