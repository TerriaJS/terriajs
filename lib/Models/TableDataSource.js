    ...
    for (var key in rowNumbersMap) {
        if (rowNumbersMap.hasOwnProperty(key)) {
            ...
            for (var i = 0; i < rowNumbersMap[key].length; i++) {
                ...
                rowNumbersForThisFeatureId.sort((a, b) => specialColumns.time.values[a] - specialColumns.time.values[b]);
                ...
                propertiesInterval.data._terria_rowNumbers = rowNumbersForThisFeatureId;
