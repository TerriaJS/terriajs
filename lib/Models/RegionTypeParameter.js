...
var RegionTypeParameter = function(options) {
    ...
    /**
     * If regionType is used by itself, it needs to be shown in the UI. If it's used with RegionParameter, the
     * RegionParameter will take care of displaying it and it shouldn't be shown in the UI. This records whether it
