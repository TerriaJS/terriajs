...
var RegionTypeParameter = function(options) {
    ...
    /**
     * If regionType is used by itself, it needs to be shown in the UI. If it's used with RegionGeometryParameter,
     * the RegionGeometryParameter will take care of displaying it and it shouldn't be shown in the UI. This records
     * whether it needs to be shown in the UI.
     */
    this.showInUi = true;
