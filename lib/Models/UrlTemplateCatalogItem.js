...
var UrlTemplateCatalogItem = function(terria) {
    ...
    knockout.track(this, ['minimumLevel', 'maximumLevel', 'attribution']);
};
...
defineProperties(UrlTemplateCatalogItem.prototype, {
    ...
    type : {
        get : function() {
            return 'url-template-map';
        }
    },

    /**
     * Gets a human-readable name for this type of data source, 'URL Template Map'.
     * @memberOf UrlTemplateCatalogItem.prototype
     * @type {String}
     */
    typeName : {
