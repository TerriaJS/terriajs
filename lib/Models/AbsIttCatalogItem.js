...
AbsIttCatalogItem.prototype._load = function() {
    ...
    loadConceptIdsAndConceptNameMap(this).then(function() {
        console.log(that._conceptIds, that._conceptNamesMap)
    });
};
...
function loadConcepts(item) {
    item._conceptIds.forEach(function(conceptId) {
        console.log('now loading', conceptId);
    });
}
 ...
 * @param  {Object} concept An object with a name property and, if a codemap is to be used, an items array of objects with a name property.
