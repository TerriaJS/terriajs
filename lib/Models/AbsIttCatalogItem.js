...
function buildTableDataSource(item, tableStructures) {
    ...
    if (tableStructures.length !== item._activeCombinations.length + 1) {
        // TODO: Improve
        console.log('Mismatch between number of combinations and number of data tables returned', tableStructures, item._activeCombinations);
        return;// when();
    }
