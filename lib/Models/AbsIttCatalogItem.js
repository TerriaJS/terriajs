...
function buildTableDataSource(item, tableStructures) {
    ...
    var newColumns = tableStructures.map(function(tableStructure, index) {
        ...
        // Pull out just the 'Value' column, and rename it to match all the codes except the region,
        ...
        valueColumn.name = absCodes
            .filter(function(absCode) { return absCode.concept.id !== item.regionConcept; })
