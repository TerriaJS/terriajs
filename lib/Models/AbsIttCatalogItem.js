...
function buildTableDataSource(item, tableStructures) {
    ...
    // Pull out only the "Value" columns, and rename them to reflect the data codes pertaining to this data file.
    var newColumns = tableStructures.map(function(tableStructure, index) {
        ...
        // Pull out just the 'Value' column, and rename it to match all the codes except the region type,
