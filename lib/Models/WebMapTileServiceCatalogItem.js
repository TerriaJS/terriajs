...
function requestMetadata(wmtsItem) {
    ...
    var metadata = wmtsItem._rawMetadata || loadXML(proxyUrl(wmtsItem.terria, wmtsItem.metadataUrl, wmtsItem.forceProxy)).then(WebMapTileServiceCatalogItem.capabilitiesXmlToJson);
