...
defineProperties(CsvCatalogItem.prototype, {
    ...
    supportsReordering: {
        get: function() {
            return defined(this._dataSource) && this._dataSource.regionDetails && !this.keepOnTop;
        }
    },
    ...
    supportsOpacity: {
        get: function() {
            return (defined(this._dataSource) && this._dataSource.regionDetails);
        }
    },
    ...
    imageryLayer : {
        get : function() {
            return this._dataSource.imageryLayer;
        }
    },
