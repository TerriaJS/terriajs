...
function updateRegionMapping(csvItem, tableStyle, showFeedback) {
    ...
    var results = regionProvider.getRegionValues(csvItem._tableDataSource.dataset, tableStyle.regionVariable, csvItem.activeRows); // ok if activeRows is undefined
    if (showFeedback) {
