...
function createRegionLookupFunc(csvItem) {
    ...
    var regionVariable = csvItem.tableStyle.regionVariable;
...
function updateTableStyle(csvItem) {
    ...
    if (defined(csvItem.tableStyle.regionType) && defined(csvItem.tableStyle.regionVariable)) {
        csvItem._regionDescriptor = csvItem._regionWmsMap[csvItem.tableStyle.regionType];
...
function addRegionMap(csvItem) {
    ...
    return updateTableStyle(csvItem);
}
