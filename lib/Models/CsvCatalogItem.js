...
var colorMaps = require('../Core/colorMaps');
...
function initRegionMapStyle(csvItem, regionProviderList) {
    ...
    if (!defined(tableStyle.colorMap)) {
        if (defined(tableStyle.colorMapName)) {
            tableStyle.colorMap = colorMaps.colorMapFromName(tableStyle.colorMapName);
        } else if (defined(tableStyle.colorMapString)) {
            tableStyle.colorMap = colorMaps.colorMapFromString(tableStyle.colorMapString);
            tableStyle.legendTicks = tableStyle.colorMap.length -2;
        } else {
            tableStyle.colorMap = colorMaps.colorMapFromString(
