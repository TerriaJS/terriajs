...
var AddImageryProviderHooks = require('../Map/addImageryProviderHooks');
            ...
            this._imageryLayer.setFilter(function () {
                new L.CanvasFilter(this, {
                    channelFilter: function (image) {
                        return AddImageryProviderHooks.recolorImage(image, that.colorFunc);
                    }
                }).render();
            });
        }
...
CsvCatalogItem.prototype._createImageryProvider = function(time) {
    ...
    var that = this;
    AddImageryProviderHooks.addRecolorFunc(imageryProvider, this.colorFunc);
    AddImageryProviderHooks.addPickFeaturesHook(imageryProvider, function(results) {
