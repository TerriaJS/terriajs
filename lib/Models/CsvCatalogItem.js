...
var CsvCatalogItem = function(terria, url) {
   ...
   /**
    ...
    knockout.track(this, ['_dataUrl', '_dataUrlType', 'url', 'data', 'dataSourceUrl', 'opacity', 'keepOnTop', '_regionMapped', '_csvDataset', 'disableUserChanges']);
