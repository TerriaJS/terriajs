...
var DataSourceClock = require('../../Cesium/Source/DataSources/DataSourceClock');
...
var WebMapServiceImageryProvider = require('../../Cesium/Source/Scene/WebMapServiceImageryProvider');
...
var CsvCatalogItem = function(application, url) {
   ...
   /**
    ...
    knockout.track(this, ['url', 'data', 'tableStyle', 'opacity', '_regionMapped']);
