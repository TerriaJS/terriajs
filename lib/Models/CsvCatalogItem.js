...
var CsvCatalogItem = function(terria, url) {
   ...
   /**
    ...
    knockout.track(this, ['data', 'dataSourceUrl', 'opacity', 'keepOnTop', '_regionMapped', '_csvDataset', 'disableUserChanges']);
...
defineProperties(CsvCatalogItem.prototype, {
     ...
     * This is not the TableDataSource, but its underlying CzmlDataSource,
     * so that it can be compared to entityCollection.owner.
     * @memberOf CsvCatalogItem.prototype
     * @type {DataSource}
     */
    dataSource : {
        get : function() {
            return this._tableDataSource.czmlDataSource;
        }
    }
});
