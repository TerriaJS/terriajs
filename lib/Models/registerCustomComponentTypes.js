...
const registerCustomComponentTypes = function(terria) {
    ...
    function processChartNode(catalogItem, feature, node, children) {
        ...
        console.log('<chart> feature.currentProperties._terria_updateTrigger', feature && feature.currentProperties && feature.currentProperties._terria_updateTrigger);
     ...
     */
        ...
        selfUpdateSeconds: function(reactComponent) {
            return 6000; // reactComponent.props.pollSeconds;
        }
    });
    if (!defined(terria)) {
