...
const ChartExpandButton = require('../ReactViews/Custom/Chart/ChartExpandButton');
 ...
 *
 *
 * <chart> displays an interactive chart (see Chart.jsx), along with an "expand" button (ChartExpandButton.jsx).
