...
WebProcessingServiceCatalogItem.prototype._getGeojson = function() {
    var geojson;
    if (defined(this.parameters) && defined(this.parameterValues)) {
        ...
        var firstRegionGeometryParameter = this.parameters.filter(function(parameter) { return parameter instanceof RegionParameter; })[0];
        if (defined(firstRegionGeometryParameter)) {
            var value = this.parameterValues[firstRegionGeometryParameter.id];
            return firstRegionGeometryParameter.regionProvider.getRegionFeature(this._terria, value, undefined).then(function(feature) {
                geojson = {
                    type: 'Feature',
...
WebProcessingServiceCatalogItem.prototype._load = function() {
    ...
    var that = this;
    return when(this._getGeojson()).then(function(geojson) {
