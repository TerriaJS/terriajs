      ...
      for (var i = 0; i < outputs.length; ++i) {
        ...
        if (defined(outputs[i].Data.LiteralData)) {
          ...
          if (outputs[i].Data.ComplexData.mimeType === "text/csv") {
            ...
            // If the server returns duplicate names, we end up having duplicate uniqueIds.
            // To avoid this we force uniqueId to a GUID.
            Object.defineProperty(catalogItem, "uniqueId", {
              value: createGuid()
            });
          }
