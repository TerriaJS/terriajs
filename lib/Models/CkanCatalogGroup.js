...
CkanCatalogGroup.prototype._load = function() {
  ...
  if (
    ...
    throw new TerriaError({
      ...
      message:
        "The definition for this CKAN catalogue does not have a valid filter query."
    });
  }
...
Otherwise, if reloading doesn\'t fix it, please report the problem by sending an email to <a href="mailto:' +
          that.terria.supportEmail +
          '">' +
          that.terria.supportEmail +
          "</a> with the technical details below.  Thank you!<br/><br/>\
<pre>" +
          formatError(e) +
          "</pre>"
      });
