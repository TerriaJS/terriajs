  ...
  return when()
    .then(function() {
      if (target instanceof Rectangle) {
        ...
        // In some cases (when a custom terrain is being rendered) height is returned as undefined from
        // the Rectangle.center function
        ...
        return sampleTerrain(terrainProvider, level, positions).then(function(
          ...
          // Result must have a height, this is a stop gap because in some cases the positions
          // in incomplete, see above note.
          if (!results[0].height) {
            results[0].height = 0.0;
          }
