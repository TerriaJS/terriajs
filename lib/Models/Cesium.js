...
Cesium.prototype.pickFromLocation = function(latlng, imageryLayerCoords, existingFeatures) {
    ...
    var result = this._buildPickedFeatures(imageryLayerCoords, pickPositionCartographic, existingFeatures, promises, imageryLayers, pickPositionCartographic.height);
 ...
 * @param {Cartographic} pickPosition The position in the 3D model that has been picked.
