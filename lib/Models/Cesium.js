...
function selectFeature(cesium) {
    ...
    if (defined(cesium._selectedFeatureCatalogItem)) {
        cesium._selectedFeatureCatalogItem._hide();
        cesium._selectedFeatureCatalogItem._disable();
        cesium._selectedFeatureCatalogItem = undefined;
    }
    ...
    if (defined(feature) && defined(feature.position)) {
        ...
        if (defined(geoJson) && defined(geoJson.geometry) && geoJson.geometry.type !== 'Point') {
            var catalogItem = cesium._selectedFeatureCatalogItem = new GeoJsonCatalogItem(cesium.terria);
            ...
            catalogItem.load().then(function() {
                if (catalogItem !== cesium._selectedFeatureCatalogItem) {
                    return;
                }
