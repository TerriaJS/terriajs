...
var Cesium = function(terria, viewer) {
    ...
    if (!this.scene.imagerySplitPosition) {
        // Start the split position somewhere sensible (default is 0).
    ...
    /**
     * Gets or sets the splitter's thumb width in pixels. Defaults to 40.
     * Required to correctly match the splitter control's appearance to the imagerySplitPosition.
     * TODO: It would be better to replace the <input> range control with a regular div so we don't need this.
     * @type {Boolean}
     */
    this.splitterThumbWidth = 40;
