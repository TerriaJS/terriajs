...
var Polling = function(options) {
  ...
  /**
   * Time of the most recent data update. Consumed by view layer to show refresh timers.
   * Only defined if polling is occuring.
   * @type {Date}
   */
  ...
  /**
   * How many seconds left until the nect update.
   * Only defined if polling is occuring.
   * @type {number}
   */
  this.secondsUntilNextUpdate = undefined;
