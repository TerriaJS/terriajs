...
var ColorMaterialProperty = require("terriajs-cesium/Source/DataSources/ColorMaterialProperty").default;
...
var PolylineGraphics = require("terriajs-cesium/Source/DataSources/PolylineGraphics").default;
var when = require("terriajs-cesium/Source/ThirdParty/when").default;
var defaultValue = require("terriajs-cesium/Source/Core/defaultValue").default;
var zip = require("terriajs-cesium/Source/ThirdParty/zip").default;

var PointGraphics = require("terriajs-cesium/Source/DataSources/PointGraphics").default;
...
function loadGeoJson(geoJsonItem) {
  ...
  return dataSource.load(geoJsonItem._readyData, options).then(function() {
    ...
    for (var i = 0; i < entities.length; ++i) {
      ...
      if (defined(entity.billboard) && defined(options.markerUrl)) {
        entity.billboard = {
          image: proxyCatalogItemUrl(geoJsonItem, options.markerUrl),
