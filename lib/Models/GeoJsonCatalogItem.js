    ...
    */
    ...
    return dataSource.load(geoJsonItem._readyData, options).then(function() {
        ...
        for (var i = 0; i < entities.length; ++i) {
            ...
            if ((defined(entity.billboard) && !defined(entity.properties)) ||
                (defined(entity.billboard) && defined(entity.properties) &&
            ...
            if (defined(entity.billboard) && defined(entity.properties) && defined(entity.properties['marker-opacity'])) {
