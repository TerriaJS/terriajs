...
CameraView.fromLookAt = function(targetPosition, headingPitchRange) {
    ...
    //Matrix4.inverseTransformation(transform, transform);
    ...
    //var direction = Matrix4.multiplyByPointAsVector(transform, directionENU, new Cartesian3());
    ...
    return new CameraView(Rectangle.MAX_VALUE, position, direction, up);
};
