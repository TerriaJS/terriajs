...
var TableColumnLegend = require('./TableColumnLegend');
...
function loadTable(csvItem, text) {
    ...
    dataSource.loadText(text);  // TODO: don't want to use a function of this name for this
    ...
    if (!dataSource.hasLocationData) {
        ...
        if (!defined(csvItem.rectangle)) {
            csvItem.rectangle = csvItem._dataSource.dataset.getExtent();
        }
        // TODO: need to restructure TableDataSource2 into TableColumns before this will work; then it should call this for us
        var legend = TableColumnLegend.fromTableColumnAndStyle(csvItem._dataSource.tableStructure.yColumns[0], csvItem._tableStyle);
        csvItem.legendUrl = legend.asPngUrl();
