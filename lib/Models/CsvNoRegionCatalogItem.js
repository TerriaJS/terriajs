...
function createRegionImageryProvider(catalogItem) {
    var region = catalogItem._region;
    ...
    //     var regionValues = catalogItem._region.regionProvider.getRegionValues(tableStructure.activeItems[0].values, region.column.values, region.disambigColumn.values);
    //     var colorFunction = catalogItem._region.regionProvider.getColorLookupFunc(regionValues, legendHelper.getColorFromValue.bind(legendHelper));
