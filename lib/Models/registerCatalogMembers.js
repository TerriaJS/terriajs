...
var DataCatalogItem = require('./DataCatalogItem');
...
var CsvNoRegionCatalogItem = require('./CsvNoRegionCatalogItem');  // TODO: temp
...
var registerCatalogMembers = function() {
    ...
    createCatalogMemberFromType.register('csv', CsvNoRegionCatalogItem);
    createCatalogMemberFromType.register('csw', CswCatalogGroup);
    createCatalogMemberFromType.register('czml', CzmlCatalogItem);
    createCatalogMemberFromType.register('data', DataCatalogItem);
