...
var AggregatedDataAPICatalogItem = require('./AggregatedDataAPICatalogItem');
...
var registerCatalogMembers = function() {
    ...
    createCatalogMemberFromType.register('aggregated-data-api', AggregatedDataAPICatalogItem);
    ...
    createCatalogItemFromUrl.register(matchesUrl(/\/datasets\//i), AggregatedDataAPICatalogItem, true);
    ...
    createCatalogItemFromUrl.register(undefined, AggregatedDataAPICatalogItem, true);
};
