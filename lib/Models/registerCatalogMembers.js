...
var SensorObservationServiceCatalogGroup = require('./SensorObservationServiceCatalogGroup');
...
var registerCatalogMembers = function() {
    ...
    createCatalogMemberFromType.register('async-result', AsyncFunctionResultCatalogItem);
    ...
    createCatalogMemberFromType.register('sos-group', SensorObservationServiceCatalogGroup);
