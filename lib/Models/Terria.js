...
Terria.prototype.updateFromStartData = function(startData, includePersistentInitSources = true) {
    var initSources = includePersistentInitSources  ? this.initSources.slice() : [];
...
Terria.prototype.addInitSource = function(initSource) {
    ...
    if (defined(initSource.viewerMode) && !defined(this.userProperties.map)) {
        ...
        if (desiredMode === '2d') {
            if(this.viewerMode !== ViewerMode.Leaflet) this.viewerMode = ViewerMode.Leaflet;
        } else if (desiredMode === '3d') {
            if(this.viewerMode !== ViewerMode.CesiumTerrain) this.viewerMode = ViewerMode.CesiumTerrain;
        } else if (desiredMode === '3dsmooth') {
            if(this.viewerMode !== ViewerMode.CesiumEllipsoid) this.viewerMode = ViewerMode.CesiumEllipsoid; 
        }
    }
