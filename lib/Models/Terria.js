...
var Terria = function(options) {
    ...
    /**
     * The currently active tab within the Explorer panel - can be serialised into a share link.
     * @type {Integer}
     * @default 0
     */
...
Terria.prototype.addInitSource = function(initSource) {
    ...
    // Populate the currently open tab.
    if (defined(initSource.activeTabIndex)) {
        this.activeTabIndex = initSource.activeTabIndex;
    }
