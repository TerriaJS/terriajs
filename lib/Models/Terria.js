...
Terria.prototype.updateFromStartData = function(startData, includePersistentInitSources = true) {
    var initSources = includePersistantInitSources ? this.initSources.slice() : this.initSources.filter(init => !(init.initFragment && init.initFragment === 'terria'));
