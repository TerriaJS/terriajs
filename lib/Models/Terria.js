...
Terria.prototype.updateApplicationUrl = function(newUrl) {
    ...
    var promise = interpretHash(hashProperties, this.userProperties, this.initSources, initSources);
    ...
    for (var property in hashProperties) {
        if (hashProperties.hasOwnProperty(property)) {
            ...
            if (property === 'clean') {
                ...
                var promise;
                if (propertyValue[0] !== '{') {
                    var path = generateUrlFromHash(propertyValue);
