...
var Terria = function(options) {
    ...
    this.corsProxy.baseProxyUrl = defaultValue(options.baseProxyUrl, this.corsProxybaseUrl); 
...
Terria.prototype.start = function(options) {
    ...
    return loadJson(options.configUrl).then(function(config) {
        ...
        corsProxy.baseProxyUrl = defaultValue(config.baseProxyUrl, corsProxy.baseProxyUrl);
        this.conversionServiceBaseUrl = config.conversionServiceBaseUrl || this.conversionServiceBaseUrl || 'convert';
        this.proj4ServiceBaseUrl = config.proj4ServiceBaseUrl || this.proj4ServiceBaseUrl ||  'proj4def/';
