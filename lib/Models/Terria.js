...
var Terria = function(options) {
    ...
    /**
     * Gets or sets the help screen, a screen which can be used alone or in series to explain a concept in terria in
     * context.
     * @type {HelpScreen[]}
     */
    this.helpScreens = [];
    ...
    knockout.track(this, ['viewerMode', 'baseMap', 'baseMapName', 'fogSettings', '_initialView', 'homeView', 'pickedFeatures', 'selectedFeature', 'mapInteractionModeStack', 'helpScreens', 'configParameters', 'showTimeline', 'catalog', 'selectBox']);
