...
var Terria = function(options) {
    ...
    // /**
    //  * Gets or sets whether the hash has been interpreted, so operations can apply once all data has been resolved.
    //  * This property is observable. Default false.
    //  * @type {Boolean}
    //  */
    // this.hashInterpreted = false;
    ...
    knockout.track(this, [
        ...
        // 'baseMapContrastColor', 'hashInterpreted'
    ]);
