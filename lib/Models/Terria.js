...
Terria.prototype.start = function(options) {
    ...
    return loadJson(options.configUrl).then(function(config) {
        ...
        that.appName = defaultValue(cp.appName, options.appName, that.appName);
        that.supportEmail = defaultValue(cp.supportEmail, options.supportEmail, that.supportEmail);
