  ...
  if (defined(json.intervalFilterFeature)) {
    ...
    mapPromise.then(() => {
      ...
      return catalogItem.load().then(() => {
        ...
        // Temporarily disable splitter so that feature picking doesn't get affected by it
        catalogItem.terria.showSplitter = false;
        ...
        catalogItem.terria.showSplitter = true;
