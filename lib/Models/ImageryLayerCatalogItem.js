...
ImageryLayerCatalogItem.prototype.createImageryProvider = function(time) {
    ...
    result.tileDownloadTimeout = 3000;
    result.tileDownloadTimeoutMessage = this.name + ': The data custodian\'s server took more than 3 seconds to return this tile, so the request was cancelled.';
    return result;
};
...
is invalid.  The catalogue item has been hidden from the map.  You may re-show it in the Now Viewing panel to try again.'
        ...
        result.errorEvent.addEventListener(function(e) {
