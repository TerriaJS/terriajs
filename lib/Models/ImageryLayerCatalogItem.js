...
var ImageryLayerCatalogItem = function(terria) {
    ...
    knockout.track(this, [
        ...
        'dontChartAlone', 'featureTimesProperty', '_allIntervals', '_intervalFilterFeature']);
...
ImageryLayerCatalogItem.prototype._show = function() {
    ...
    if (this.showOnChart && this.terria.catalog.chartableItems.indexOf(this) < 0) {
 ...
 */
ImageryLayerCatalogItem.prototype.filterIntervalsByFeature = function(feature) {
