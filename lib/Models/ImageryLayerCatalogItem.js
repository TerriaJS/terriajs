      ...
      operation.attempt(function() {
        ...
        maybeXhr
          .then(function() {
            ...
            // Handle SPDY errors between chrome and cloudfront
            if (error.statusCode === undefined && usersBrowserIsChrome) {
              console.log(
                "Terria Tile Error between cloudfront and chrome, net::ERR_SPDY_SERVER_REFUSED_STREAM"
              );
