...
/**
 * Parses the value into a Cartographic and stores the value as this.value, otherwise updates this.value to undefined.
 * @param {String} value Text that is to be parsed.
 */
PointParameter.prototype.parseParameterLonLat = function(value) {
    this.value = this.tryParseCartographicValueFromTextLonLat(value);
}
