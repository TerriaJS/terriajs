...
interface ConfigParameters {
  ...
  /**
   * Optional path to dynamic favicon
   */
  faviconPath?: string;
}
...
export default class Terria {
  ...
  async start(options: StartOptions) {
    ...
    // TODO: To update all different size favicons, we could appendChild for all, or insert the 'code.txt' file generated by https://favicomatic.com/
    if (this.configParameters.faviconPath) {
      // let link = document.querySelector("link[rel~='icon']") as HTMLLinkElement; // Old Favicon
      const link = document.createElement("link");
      link.rel = "icon";
      link.href = `${this.configParameters.faviconPath}/favicon.ico`;
