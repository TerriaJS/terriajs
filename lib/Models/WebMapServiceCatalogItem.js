...
var WebMapServiceCatalogItem = function(terria) {
    ...
    this.availableStyles = {
        'FVCOM-NECOFS-GOM3/x': [{
            ...
            name: 'default-scalar/div-RdBu-inv',
            title: 'default-scalar/div-RdBu-inv',
            abstract: 'default-scalar style, using the div-RdBu-inv palette',
            legendUrl: new LegendUrl('http://www.smast.umassd.edu:8080/ncWMS2/wms?REQUEST=GetLegendGraphic&PALETTE=div-RdBu-inv&COLORBARONLY=true&WIDTH=110&HEIGHT=264', 'image/png')
        }]
    };
    ...
    knockout.track(this, [
        ...
        'disableUserChanges', 'availableStyles']);
...
WebMapServiceCatalogItem.prototype.refresh = function() {
    ...
    if (defined(this._legendUrl)) {
        ...
        if (defined(this.styles) && (!defined(this.parameters.styles) || this.parameters.styles.length === 0)) {
            // TODO: support multiple layers
            legendUri.setQuery('styles', this.styles);
        }
