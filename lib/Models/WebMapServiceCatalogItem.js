...
var WebMapServiceCatalogItem = function(terria) {
     ...
     * property supported by ncWMS servers, this property is ignored unless {@link WebMapServiceCatalogItem#isNcWMS}
    ...
    /**
     * Gets or sets the set of additional dimensions (e.g. elevation) and their possible values available from the
     * WMS server.  If undefined, this property is automatically populated from the WMS GetCapabilities on load.
     * This property is an object that has a property named for each layer.  The value of the property is an object
     * that has a property named for each dimension.  The value of that property is an array
     * where each element in the array is a possible value for that dimension.  This property is observable.
     * @type {Object}
     * @example
    ...
    overrideProperty(this, 'legendUrls', {
        get : function() {
            var legendUrls = legendUrlsBase.get.call(this);
 ...
 */
WebMapServiceCatalogItem.prototype.updateFromCapabilities = function(capabilities, overwrite, thisLayer, availableStyles) {
    ...
    if (!defined(this.availableStyles)) {
        if (!defined(availableStyles)) {
            availableStyles = WebMapServiceCatalogItem.getAllAvailableStylesFromCapabilities(capabilities);
        }
    ...
    if (this.isNcWMS) {
        updateValue(this, overwrite, 'colorScaleMinimum', -50);
        updateValue(this, overwrite, 'colorScaleMaximum', 50);
    }
};
