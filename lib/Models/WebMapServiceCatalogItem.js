...
WebMapServiceCatalogItem.prototype.updateFromCapabilities = function(capabilities, overwrite, thisLayer) {
    ...
    this._lazyLoadInterval = function() {
      // Times loading is very inefficient for some datasets with lots of time intervals.
      // So we lazy load it.
...
WebMapServiceCatalogItem.prototype._load = function() {
    ...
    if (this._lazyLoadInterval) {
        this._lazyLoadInterval();
        delete this._lazyLoadInterval;
    }
