...
WebMapServiceCatalogItem.prototype.searchDataForMatchingFeatures = function(searchText, regex) {
    ...
    return new Promise(function(resolve, reject) {
        ...
        if (that.hasLinkedWfs === false) {
           resolve(workbenchItemResults);
        } else if (that.hasLinkedWfs) {
            that.linkedWfs.searchDataForMatchingFeatures(searchText, regex).then(function (res) {
                workbenchItemResults = convertWfsSearchResultsToWms(res, that);
                resolve(workbenchItemResults);
            });
            ...
            .then(function(xml) {
                ...
                that.linkedWfs._load().then(function (result) {
