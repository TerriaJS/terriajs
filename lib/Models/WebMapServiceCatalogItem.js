...
function momentParsedWithTimeZone(date) {
    var format = moment.creationData().format;
    return format.length > 0 && format[format.length - 1] === 'Z';
}
...
function getIntervalsFromLayer(wmsItem, layer) {
    ...
    for (var i = 0; i < dimensions.length; ++i) {
        ...
        //             if (candidate.name && candidate.name.toLowerCase() === 'time') {
        //                 extent = candidate;
        //                 break;
        //             }
        //         }
