...
var Cesium3DTileFeature = require('terriajs-cesium/Source/Scene/Cesium3DTileFeature');
...
var Cesium3DTilesCatalogItem = function(terria) {
    ...
    knockout.track(this, ['options', 'ionAssetId', 'ionAccessToken', 'ionServer', 'style', 'filters']);

    this._computedStyleSubscription = undefined;
...
Cesium3DTilesCatalogItem.prototype._enableInCesium = function() {
    if (!defined(this._tileset)) {
        ...
        if (this._computedStyleSubscription) {
            this._computedStyleSubscription.dispose();
            this._computedStyleSubscription = undefined;
        }

        this._computedStyleSubscription = knockout.getObservable(this, '_computedStyle').subscribe(value => {
