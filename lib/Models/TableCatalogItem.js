...
var TableCatalogItem = function(terria, url, options) {
     ...
     * @type {Object}
     */
    knockout.defineProperty(this, 'idToDistinguishChartsOfTheSameFeature', {
        get : function() {
            return;
        }
    });
...
TableCatalogItem.defaultUpdaters.idToDistinguishChartsOfTheSameFeature = function() {
    // Don't update from JSON.
};
...
TableCatalogItem.defaultSerializers.idToDistinguishChartsOfTheSameFeature = function() {
    // Don't serialize.
};
