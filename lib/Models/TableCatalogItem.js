...
TableCatalogItem.defaultUpdaters.tableStyle = function(csvItem, json, propertyName, options) {
    return csvItem._tableStyle.updateFromJson(json[propertyName], options);
};

TableCatalogItem.defaultUpdaters.polling = function(csvItem, json, propertyName, options) {
...
TableCatalogItem.defaultSerializers.tableStyle = function(csvItem, json, propertyName, options) {
...
TableCatalogItem.defaultSerializers.polling = function(csvItem, json, propertyName, options) {
    json[propertyName] = csvItem[propertyName].serializeToJson(options);
};
 ...
 */
TableCatalogItem.setActiveTimeColumn = function(tableStructure, tableStyle) {
...
TableCatalogItem.prototype.initializeFromTableStructure = function(tableStructure) {
    ...
    TableCatalogItem.setActiveTimeColumn(tableStructure, tableStyle);
