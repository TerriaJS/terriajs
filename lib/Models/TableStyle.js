...
var TableStyle = function(options) {
    ...
    /**
     * The URL of a GeoJSON file with regions to use with this csv. Overrides regionType
     * @type {String}
     */
    this.regionsGeoJsonUrl = options.regionsGeoJsonUrl;

    /**
     * The property to match GeoJSON region features with the regionVariable table column.
     * @type {String}
     */
    this.regionsGeoJsonProperty = options.regionsGeoJsonProperty;
