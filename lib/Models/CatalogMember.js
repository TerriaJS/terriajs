...
CatalogMember.prototype.waitForDisclaimer = function() {
    var deferred = when.defer();

    this.terria.disclaimerEvent.raiseEvent(this, deferred.resolve);
...
CatalogMember.prototype.load = function() {
    ...
    var promises = [
        ...
        this.needsDisclaimerShown ? this.waitForDisclaimer() : when()
    ];

    this._loadingPromise = when.all(promises).then(function(resultArray) {
