...
var CatalogMember = function(terria) {
    ...
    */
    ...
    /**
     * A message that is presented to the user when an item or group is initially clicked
     * This property is observable.
     * @type {String}
     */
    ...
    knockout.track(this, ['name', 'info', 'description', 'isUserSupplied', 'isPromoted', 'initialMessage']);
};
