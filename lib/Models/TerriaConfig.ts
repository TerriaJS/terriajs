...
export class TerriaConfig {
   ...
   */
  shareClientBaseUrl?: string | undefined = undefined;
  /**
   ...
   */
  disableSharePanel?: boolean | undefined = false;
  /**
   * True to disable the share embed panel.
   */
  disableShareEmbed?: boolean | undefined = false;

  /**
   * True to disable user added data.
   */
  disableUserAddedData?: boolean | undefined = false;
  /**
  ...
  /**
   * Configurable disclaimer that shows up in print view
   */
