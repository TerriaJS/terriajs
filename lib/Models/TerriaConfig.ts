...
export interface ConfigParameters {
  ...
  shareRequestHeaders?: (() => Promise<Record<string, string>>) | undefined;
  /**
   ...
   */
  shareClientBaseUrl?: string | undefined;
  /**
  ...
  feedbackRequestHeaders?: (() => Promise<Record<string, string>>) | undefined;
  /**
   ...
   */
  cesiumIonDisableDefaultToken?: boolean | undefined;
  /**
   * A [Bing Maps API
   ...
   */
  disableMobileInterface?: boolean | undefined;
  /**
   ...
   */
  disableSharePanel?: boolean | undefined;
  /**
   * True to disable the share embed panel.
   */
  disableShareEmbed?: boolean | undefined;

  /**
   * True to disable user added data.
   */
  disableUserAddedData?: boolean | undefined;
   ...
   */
  postHogAnalyticsKey?: string | undefined;

  /**
   * PostHog analytics host
   */
  postHogAnalyticsHost?: string | undefined;
...
export class TerriaConfig implements ConfigParameters {
  ...
  @observable shareClientBaseUrl: string | undefined = undefined;
  @observable shareRequestHeaders:
    | (() => Promise<Record<string, string>>)
    | undefined = undefined;
  @observable feedbackUrl: string | undefined = undefined;
  @observable feedbackRequestHeaders:
    | (() => Promise<Record<string, string>>)
    | undefined = undefined;
  ...
  @observable cesiumIonDisableDefaultToken: boolean | undefined = false;
  ...
  @observable disableMobileInterface: boolean | undefined = false;
  ...
  @observable disableSharePanel: boolean | undefined = false;
  @observable disableShareEmbed: boolean | undefined = false;
  @observable disableUserAddedData: boolean | undefined = false;
  ...
  @observable postHogAnalyticsKey: string | undefined = undefined;
  @observable postHogAnalyticsHost: string | undefined = undefined;
