...
var Feature = function(options) {
    ...
    /**
     * Gets or sets a counter used to trigger an update of the Feature Info Section,
     * to allow custom components to self-update. This property is observable.
     * @type {Number}
     */
    this.updateCounter = undefined;

    knockout.track(this, ['currentProperties', 'currentDescription', 'updateCounter']);
};
