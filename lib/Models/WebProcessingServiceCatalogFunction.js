...
WebProcessingServiceCatalogFunction.parameterConverters = [
    {
        ...
        functionParameterToKvpInput: function(catalogFunction, parameter, value) {
    ...
    },
    {
        ...
        functionParameterToKvpInput: function(catalogFunction, parameter, value) {
            return PointParameter.formatValueForUrl(value, parameter);
        }
    },
    {
         id: 'LineGeometry',
    ...
    },
    {
         ...
         functionParameterToKvpInput: function(catalogFunction, parameter, value) {
             return PolygonParameter.formatValueForUrl(value, parameter);
         }
    },
    {
...
function loadResponse(that, dataInputs, asyncResult, proxyCacheDuration) {
    var parameters = {identifier: that.identifier,
...
function createWpsDataInputsFromParameters(catalogFunction) {
    return catalogFunction.parameters.map(function(parameter) {
        ...
        if (catalogFunction.useKvp) {
            return parameter.converter.functionParameterToKvpInput(catalogFunction, parameter, value);
        } else {
