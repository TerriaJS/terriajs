...
Leaflet.prototype.pickLocation = function(latlng, imageryLayerCoords) {
    ...
    return runLater(function() {
        ...
        pickFeatures(this, latlng, {x: imageryLayerCoords.x, y: imageryLayerCoords.y}, imageryLayerCoords.level);
        return this.terria.pickedFeatures.allFeaturesAvailablePromise;
    }.bind(this));
};
