...
/**
 * Creates a new layer using a provided ImageryProvider and adds it to the scene.
 * Note the optional parameters are a subset of the Cesium equivalent, with one addition (onProjectionError).
 *
...
Leaflet.prototype.showImageryLayer = function(options) {
    if (!this.map.hasLayer(options.layer)) {
        ...
        // TODO: this is badly done so far.
