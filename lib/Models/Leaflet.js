...
Leaflet.prototype.pickLocation = function(latlng, imageryLayerCoords, existingFeatures) {
    prePickFeatures(this);
    this._pickedFeatures.features = existingFeatures;

    pickFeatures(this, latlng, imageryLayerCoords, imageryLayerCoords.level);
};
...
function featurePicked(leaflet, entity) {
    ...
    leaflet._pickedFeatures.pickPosition = entity.position;
}
