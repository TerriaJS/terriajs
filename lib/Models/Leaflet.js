...
/**
 * Add and remove attribution text.
 * @param {attribution} the attribution object of each Catalog item.
 */
 ...
 * @param {attribution object} for leaflet to display as text or link
 * @return {[String] text }
 */
