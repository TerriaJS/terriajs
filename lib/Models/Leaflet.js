...
Leaflet.prototype.pickLocation = function(latlng, imageryLayerCoords) {
    ...
    this._pickedFeatures = pickFeatures(this, latlng, imageryLayerCoords, imageryLayerCoords.level);
    ...
    if (defined(latlng)) {
        ...
        for (var i = 0; i < activeItems.length; ++i) {
            ...
            if (dataSource.isEnabled && dataSource.isShown && defined(dataSource.imageryLayer) && defined(dataSource.imageryLayer.pickFeatures)) {
                ...
                promises.push(dataSource.imageryLayer.pickFeatures(leaflet.map, CesiumMath.toRadians(latlng.lng), CesiumMath.toRadians(latlng.lat), tileCoordinates[imageryLayerUrl], level));
