...
var s = require('leaflet-side-by-side');  // TODO: must require the same version of Leaflet (not 0.7.7).
...
var Leaflet = function(terria, map) {
    ...
    knockout.getObservable(this, 'showSplitter').subscribe(function() {
...
Leaflet.prototype.showImageryLayer = function(options) {
    ...
    this.updateLayerOrder();
    this.updateSplitLayers(); // TODO: temp
};
...
Leaflet.prototype.updateSplitLayers = function() {
    if (this.showSplitter) {
        ...
        // Layers which are neither right nor left - but might have been previously - need to be refreshed explicitly.
        // TODO: This is a dodgy way of doing it - and it doesn't work.
        bothLayers.forEach(layer => {
