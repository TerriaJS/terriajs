...
Leaflet.prototype.getRealWorldViewDimensions = function() {
    return {
...
Leaflet.prototype.getRealWorldViewDimensions = function() {
    var topLeftLatLng = this.map.layerPointToLatLng(L.point(0, 0));
    var bottomRightLatLng = this.map.layerPointToLatLng(L.point(this.map._container.offsetWidth, this.map._container.offsetHeight));

    return {
        topLeft: {
            latitude: topLeftLatLng.lat,
            longitude: topLeftLatLng.lng
        },
        bottomRight: {
            latitude: bottomRightLatLng.lat,
            longitude: bottomRightLatLng.lng
        }
    };
};
