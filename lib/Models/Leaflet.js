...
var Leaflet = function(terria, map) {
    ...
    // Show the imagery split control if needed.
    // TODO: make this optional!
    // this._sideBySide = undefined; // If this is defined, show the side-by-side (split) control.
...
Leaflet.prototype.updateSplitLayers = function() {
    if (defined(this._sideBySide)) {
        ...
        this.map.eachLayer(layer => {
            if (layer.splitDirection === ImagerySplitDirection.LEFT) {
    ...
    // if (defined(options.splitDirection)) {
    //     if (options.splitDirection === ImagerySplitDirection.LEFT) {
    //         this._sideBySide.setLeftLayers(this._sideBySide._leftLayers.concat(options.layer));
    //     }
    //     if (options.splitDirection === ImagerySplitDirection.RIGHT) {
    //         this._sideBySide.setRightLayers(this._sideBySide._rightLayers.concat(options.layer));
    //     }
    // }
};
