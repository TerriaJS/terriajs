...
CatalogItem.prototype.useClock = function() {
    ...
    return when(this.load(), function() {
        if (!defined(that.clock)) {
            ...
            document.getElementsByClassName('animation-timeline')[0].style.visibility = 'hidden';
            return;
        }
        ...
        document.getElementsByClassName('animation-timeline')[0].style.visibility = 'visible';

        if (defined(that.terria.cesium)) {
            document.getElementsByClassName('cesium-widget-credits')[0].style.bottom = '26px';
