...
var CatalogItem = function(terria) {
     ...
     * Returns undefined if it is not possible to query the time (i.e. the item doesn't have a clock, avaliableDates or
     * intervals. i.e. when canUseOwnClock is false).
     *
