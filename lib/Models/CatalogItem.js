...
var CatalogItem = function(terria) {
    ...
    /**
     * Gets or sets the URL of the thumbnail for this data item, or undefined if this data item does not have a legend.
     * This property is observable.
     * @type {String}
     */
    ...
    knockout.track(this, ['rectangle', 'legendUrl', 'dataCustodian', 'attribution',
                          ...
                          'isLoading', 'isMappable', 'showsInfo', 'nowViewingMessage',
						              'url', 'thumbnailUrl', 'isBasemap', '_legendUrls', '_dataUrl', '_dataUrlType']);
