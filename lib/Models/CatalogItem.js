 ...
 * @type {String[]}
 */
CatalogItem.defaultPropertiesForSharing = [...CatalogMember.defaultPropertiesForSharing, 
    'isEnabled', 'isShown', 'isLegendVisible', 'nowViewingIndex', 'nowViewingCatalogItem', 'useOwnClock'];
...
/* Returns the start time of the index-th interval. */
...
/* Returns the index of the interval that contains the item's current time, or undefined. */
