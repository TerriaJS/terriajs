...
CatalogItem.defaultMetadata.dataSourceErrorMessage =
  "This data item does not have any details available.";
CatalogItem.defaultMetadata.serviceErrorMessage =
...
function updateIndex(catalogItem, index) {
  ...
  // if (catalogItem.tempChartData) {
  //   catalogItem.selectedIndex = index;
  //   catalogItem.tempChartData.selectedIndex = index;
  //   catalogItem.tempChartData.renderer.highlightMoment(index);
  // }
