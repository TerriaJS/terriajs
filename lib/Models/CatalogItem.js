...
var CatalogItem = function(terria) {
    ...
    /**
     * Options for formatting current time and timeline tic labels. See tests for examples.
     * @type {Object}
     */
    this.dateFormat = {};

    /**
     * Options for the value of the animation timeline at start. See tests for examples.
     * @type {String}
     */
    this.timesliderInitTime = undefined;
