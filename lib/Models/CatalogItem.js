...
var CatalogItem = function(terria) {
    ...
    /**
     * Gets or sets an internal flag to keep track of whether this item should be prevented from being duplicated.
     ...
     * Default false (ie. can be duplicated). Once an item has been duplicated, it cannot be duplicated again.
     * TODO: It would be nice to include a link to the duplicate item, so when either is removed, the remaining item can be duplicated again.
     * @type {Boolean}
     */
