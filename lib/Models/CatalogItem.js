...
var CatalogItem = function(terria) {
    ...
    // it can be an independent knockout observable with all of the machinary that implies for free, without making a sub
    ...
    knockout.defineProperty(this, '_mirroringTerriaClock', {
        get: function() {
          return this.isEnabled && this.isShown && !this.useOwnClock && defined(this.clock);
        }
    });
 ...
 */
CatalogItem.prototype.nextTime = function() {
 ...
 */
CatalogItem.prototype.previousTime = function() {
 ...
 */
CatalogItem.prototype.nextTimeAvaliable = function() {
 ...
 * @returns {Boolean} True if it is possible.
 */
CatalogItem.prototype.previousTimeAvaliable = function() {
...
function timeAtIndex(catalogItem, index) {
    if (defined(index) && defined(catalogItem.availableDates) && (index >= 0) && (index < catalogItem.availableDates.length)) {
        return catalogItem.availableDates[index];
    }
