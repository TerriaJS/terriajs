...
function getRectangleFromLayer(thisLayerJson) {
    ...
    if (defined(extent) && extent.spatialReference && extent.spatialReference.wkid) {
        ...
        return Rectangle.fromDegrees(
            proj4(proj4definitions[wkid], 'EPSG:4326', extent.xmin),
            proj4(proj4definitions[wkid], 'EPSG:4326', extent.ymin),
            proj4(proj4definitions[wkid], 'EPSG:4326', extent.xmax),
            proj4(proj4definitions[wkid], 'EPSG:4326', extent.ymax));
