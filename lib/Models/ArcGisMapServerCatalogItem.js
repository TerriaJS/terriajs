...
var ArcGisMapServerCatalogItem = function(terria) {
    ...
    this._generatedUrl = undefined;  // a LegendUrl object pointing to a data URL of a legend generated by us
    ...
    if (!defined(this._legendUrl)) {
        ...
        legendData = getJson(this, legendUri)
            ...
            .then(function(legendImageUrl) {
                return (that._generatedLegendUrl = new LegendUrl(legendImageUrl, 'image/png'));
            });
    }
