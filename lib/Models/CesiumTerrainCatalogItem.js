...
var CesiumTerrainCatalogItem = function(terria) {
  ...
  /**
   * Sets the terrain provider requestVertexNormals. This is needed for material rendering of
   * Cesium terrain.
   * @type {Boolean}
   */
  this.requestVertexNormals = true;
};
...
CesiumTerrainCatalogItem.prototype._createTerrainProvider = function() {
  console.log("CesiumTerrainCatalogItem this: ", CesiumTerrainCatalogItem); // Not getting called
