...
export const SearchBarConfigSchema = z.object({
  ...
  recommendedListLength: z
    .number()
    .default(5)
    .describe("Maximum amount of entries in the suggestion list."),
  flightDurationSeconds: z
    .number()
    .default(1.5)
    .describe(
  ...
  showSearchInCatalog: z
    .boolean()
    .default(true)
    .describe("Whether to show 'Search In Catalog' in search results"),
  boundingBoxLimit: z
    .object({
      west: z.number(),
      south: z.number(),
