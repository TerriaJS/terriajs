...
var KmlDataSource = require('../../Cesium/Source/DataSources/KmlDataSource');
...
function doneLoading(kmlItem) {
    ...
    if (defined(kmlItem.application.cesium)) {
        ...
        var terrainProvider = kmlItem.application.cesium.scene.globe.terrainProvider;
