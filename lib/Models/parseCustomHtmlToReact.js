 ...
 * @param  {String} html
 * @param  {[CatalogItem]} catalogItem Provide this if any custom components need to know which catalogItem they come from.
 * @param  {[Feature]} feature Provide this if any custom components need to know what feature they come from.
 * @return {ReactElement}
 */
