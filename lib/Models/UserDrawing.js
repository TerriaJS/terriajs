 ...
 * @callback {onPointClicked} options.onPointClicked Optional way to subscribe to point clicks
 * @callback {onCleanUp} options.onCleanUp Optional way to add own cleanup
 * @callback {onMakeDialogMessage} options.onMakeDialogMessage Optional way to customise dialog message
 */
