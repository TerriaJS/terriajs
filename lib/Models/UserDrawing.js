 ...
 * @param {Object} options Object with the following properties, all of which are optional except terria:
 ...
 * @callback {onPointClicked} options.onPointClickedCallback Optional way to subscribe to point clicks
 * @callback {onCleanUp} options.onCleanUpCallback Optional way to add own cleanup
 * @callback {onMakeDialogMessage} options.onMakeDialogMessageCallback Optional way to customise dialog message
 */
