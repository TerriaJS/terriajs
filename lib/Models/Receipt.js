...
function launchStory(params, terria) {
  ...
  //Remove the old loaded story.
  terria.resetSourcesAndCatalog();
...
function exitStory(viewState) {
  ...
  var initSources = [{ initFragment: "receipt" }, { initFragment: "/" }];
  viewState.terria.loadInitSources(viewState.terria, initSources);
