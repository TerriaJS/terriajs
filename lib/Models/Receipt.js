...
/**
 * Modify layout based on url params
 * @param params
 * @param viewState
 * @constructor
 */
...
function RCChangeUrlParams(params = getUrlParams(), viewState) {
  ...
  viewState.filterHotspots({ sector: params.sector });
...
function exitStory(terria, viewState) {
  // clean url params
  // TODO
  // window.history.pushState(null, null, "/?section=agriculture");
  // window.dispatchEvent(new Event("popstate"));
