 ...
 * @param {String} [options.legendName] Display name for this column to use for the legend (defaults to `options.name` if available, otherwise the column name).
 * @param {String} [options.description] A longer description of the column.
