...
var TableColumnStyle = function(options) {
    ...
    /**
     * True to allow colors in the palette to be used for multiple enum values when there are more enum values than colors available.
     * If false, the remaining values after the most common ones have been assigned colors from the palette will be given a neutral
     * color and labelled "Other" in the legend.
     * @type {Boolean}
     * @default true
     */
    this.allowEnumColorReuse = true;
};
