 ...
 * @param {Float} [options.axisMin] Minimum value to display in charts; if not specified, minimum data value will be used.
 ...
 * @param {Float} [options.axisMax] Maximum value to display in charts; if not specified, maximum data value will be used.
 ...
 * @param {String} [options.color] Override color for column for charts.
...
var TableColumnStyle = function(options) {
    ...
    /**
     * Minimum value to display in charts; if not specified, minimum data value will be used.
     * @type {Float}
     */
    ...
    /**
     * Maximum value to display in charts; if not specified, maximum data value will be used.
     * @type {Float}
     */
    this.axisMax = options.axisMax;
