...
REpresentationalStateTransferCatalogFunction.parameterConverters = [
    ...
    }/*,//stub code for region parameters if useful for others, not tested
    {
        id: 'RegionTypeParameter',
        inputToFunctionParameter: function(catalogFunction, input) {
            if (!defined(input.RegionTypeParameter)) {
                return undefined;
            }
            return new RegionTypeParameter({
                terria: catalogFunction.terria,
                catalogFunction: catalogFunction,
                id: input.RegionTypeParameter.id,
                name: input.RegionTypeParameter.name,
                description: input.RegionTypeParameter.description,
                isRequired: input.RegionTypeParameter.isRequired
            });
        },
        functionParameterToInput: function(catalogFunction, parameter, value) {
            return {
    ...
    {
        id: 'RegionDataParameter',
        inputToFunctionParameter: function(catalogFunction, input) {
            if (!defined(input.RegionDataParameter)) {
                return undefined;
            }
            return new RegionDataParameter({
                terria: catalogFunction.terria,
                catalogFunction: catalogFunction,
                id: input.RegionDataParameter.id,
                name: input.RegionDataParameter.name,
                description: input.RegionDataParameter.description,
                isRequired: input.RegionDataParameter.isRequired,
                regionProvider: input.RegionDataParameter.regionProvider
            });
        },
        functionParameterToInput: function(catalogFunction, parameter, value) {
            return {
    ...
    },
    {
        id: 'RegionParameter',
        inputToFunctionParameter: function(catalogFunction, input) {
            if (!defined(input.RegionParameter)) {
                return undefined;
            }
            return new RegionParameter({
                terria: catalogFunction.terria,
                catalogFunction: catalogFunction,
                id: input.RegionParameter.id,
                name: input.RegionParameter.name,
                description: input.RegionParameter.description,
                isRequired: input.RegionParameter.isRequired
                regionProvider: input.RegionDataParameter.regionProvider
            });
        },
        functionParameterToInput: function(catalogFunction, parameter, value) {
