...
var USER_ADDED_CATEGORY_NAME = require('../Core/addedByUser').USER_ADDED_CATEGORY_NAME;
...
var Catalog = function(terria) {
    ...
    knockout.defineProperty(this, 'userAddedDataGroupIfItExists', {
        get: function() {
            return this._group.findFirstItemByName('User-Added Data');
        }
    });
};
