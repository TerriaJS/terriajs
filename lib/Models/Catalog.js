...
var Catalog = function(terria) {
    ...
    knockout.defineProperty(this, 'userAddedDataGroup', {
        get : this.upsertCatalogGroup.bind(this, 'User-Added Data', 'The group for data that was added by the user via the Add Data panel.')
    });

    knockout.defineProperty(this, 'chartDataGroup', {
        get : this.upsertCatalogGroup.bind(this, 'Chart Data', 'A group for chart data.', {
            colors: ['#66c2a5','#fc8d62','#8da0cb','#e78ac3','#a6d854','#ffd92f','#e5c494','#b3b3b3'] // TODO: make this customizable, use colormap
        })
    });
 ...
 * @param  {Object} [customProperties] The catalog group's custom properties.
 * @return {CatalogGroup}       The new or updated catalog group.
 */
Catalog.prototype.upsertCatalogGroup = function(name, description, customProperties) {
    var group;
