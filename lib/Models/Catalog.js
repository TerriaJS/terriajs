...
Catalog.prototype.addChartableItem = function(item){
    if (this.chartableItems.indexOf(item) === -1) {
        this.chartableItems.push(item);
    }
}

Catalog.prototype.removeChartableItem = function(item) {
    this.chartableItems = this.chartableItems.filter(ci => ci !== item);
    // var indexInChartableItems = this.chartableItems.indexOf(item);
    // if (indexInChartableItems >= 0) {
    //     this.chartableItems.splice(indexInChartableItems, 1);
    // }
}
