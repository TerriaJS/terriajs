...
/**
 * Calls {@link CsvDataset#updateFunction} function, if one is defined, with the selected
 * variable and sets the {@link CsvVariable#isActive} to true for the selected variable and
 * to false for all other variables
 *
 * @param {String} selectedVariable The selected variable.
 */
