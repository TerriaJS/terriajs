...
var CustomTagType = function(options) {
    ...
    var that = this;
    /**
     * A function that creates a replacement DOM element. It must have the given unique id.
     * @callback CustomTagType~createContainer
     * @param {String} id The id attribute of the DOM element to be created.
    ...
    /**
     * Gets or sets the replacement DOM element id.
     * @type {String}
     */
     ...
     */
    this.createContainer = defaultValue(options.createContainer, defaultCreateContainer).bind(null, this.containerId);
