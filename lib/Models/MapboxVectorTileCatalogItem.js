...
const MapboxVectorTileCatalogItem = function(terria) {
    ...
    knockout.track(this, ['lineColor', 'fillColor', 'layer', 'idProperty', 'nameProperty', '_legendUrl']);
...
function featureInfoFromFeature(mapboxVectorTileCatalogItem, feature) {
    ...
    if (defined(mapboxVectorTileCatalogItem.nameProperty)) {
        featureInfo.name = feature.properties[mapboxVectorTileCatalogItem.nameProperty];
    }
    featureInfo.properties = clone(feature.properties);
    featureInfo.data = { id: feature.properties[mapboxVectorTileCatalogItem.idProperty] }; // For highlight
    return featureInfo;
}
