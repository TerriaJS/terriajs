...
var defaultScalarColorMap = [
  { offset: 0.0, color: "rgba(239,210,193,1.0)" }, // eslint-disable-line i18next/no-literal-string
  { offset: 0.25, color: "rgba(221,139,116,1.0)" }, // eslint-disable-line i18next/no-literal-string
  { offset: 0.5, color: "rgba(255,127,46,1.0)" }, // eslint-disable-line i18next/no-literal-string
  { offset: 0.75, color: "rgba(255,65,43,1.0)" }, // eslint-disable-line i18next/no-literal-string
  { offset: 1.0, color: "rgba(111,0,54,1.0)" } // eslint-disable-line i18next/no-literal-string
];
...
var defaultNullLabel = i18next.t("models.legendHelper.defaultNullLabel");
  ...
  if (
    ...
    if (legendHelper.regionProvider) {
      legendHelper._binColors = buildEnumBinColors(
        ...
        "top", // eslint-disable-line i18next/no-literal-string
        undefined
      );
...
function buildEnumBinColors(legendHelper, uniqueValues, method, colorBins) {
  ...
  if (Array.isArray(colorBins)) {
    ...
    if (method === "auto") {
      method = "top"; // eslint-disable-line i18next/no-literal-string
    }
...
function buildEnumLegendProps(legendHelper, uniqueValues) {
  ...
  if (legendHelper._cycleEnumValues) {
    ...
    if (uniqueValues.length > count) {
      items.push({
        title: i18next.t("models.legendHelper.otherValues", {
          number: uniqueValues.length - count
        }),
...
function buildBinColors(legendHelper, colorBins) {
  ...
  if (method === "auto") {
    if (numericalValues.length > 1000) {
      ...
      method = "quantile"; // eslint-disable-line i18next/no-literal-string
    } else {
      method = "ckmeans"; // eslint-disable-line i18next/no-literal-string
    }
  }
...
function convertColorArrayToCssString(colorArray) {
  return (
    "rgba(" + // eslint-disable-line i18next/no-literal-string
    colorArray[0] +
    "," +
    colorArray[1] +
    "," +
...
function variousValuesTitle(tableColumn) {
  return i18next.t("models.legendHelper.values", {
    number: tableColumn.uniqueValues.length
  });
}
...
function buildLegendProps(legendHelper, colorMap) {
  ...
  if (!binColors) {
    ...
    return {
      ...
      labelTickColor: "darkgray", // eslint-disable-line i18next/no-literal-string
