...
var SensorObservationServiceCatalogItem = function(terria, url) {
     ...
     * @type {Integer}
     */
    this.responseSizeLimit = 225;  // Actually 250, protect against >1 timeseries/feature?
...
SensorObservationServiceCatalogItem.prototype.loadIntoTableStructure = function(url) {
    ...
    console.log('Loading observations for ' + featureOfInterestIdentifiers.length + ' features.');
