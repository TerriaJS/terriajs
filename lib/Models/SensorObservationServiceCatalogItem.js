...
function loadFeaturesOfInterest(item) {
    return querySos(item, { 
        ...
        var geojson = {
            ...
            style: {
                markerSize: 16  // TODO: get this from an item property, perhaps.
            },
        ...
        item._geoJsonItem = new GeoJsonCatalogItem(item.terria);
        item._geoJsonItem.data = featureDataToGeoJson(geojson);
