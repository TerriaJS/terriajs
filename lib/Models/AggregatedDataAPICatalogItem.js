...
defineProperties(AggregatedDataAPICatalogItem.prototype, {
    ...
    propertiesForSharing: {
        get: function() {
            return AggregatedDataAPICatalogItem.defaultPropertiesForSharing;
        }
    },
    ...
    serializers: {
        get: function() {
            return AggregatedDataAPICatalogItem.defaultSerializers;
        }
    }
});
...
AggregatedDataAPICatalogItem.prototype._load = function() {
    ...
    if (!defined(item.base_url) || !defined(item.tableCode)) {
        ...
        if (item.name === item.url) {
            item.name = item.tableCode;  // Could even improve on this with a fuller name from the API.
        }
    }
