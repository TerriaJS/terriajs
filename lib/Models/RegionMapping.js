...
function setNewRegionImageryLayer(regionMapping, layerIndex, regionIndices) {
    ...
    var regionImageryProvider = new MapboxVectorTileImageryProvider({
        url: /*'https://{s}.tiles.mapbox.com/v4/steve9164.athkphv3/{z}/{x}/{y}.vector.pbf?access_token=pk.eyJ1Ijoic3RldmU5MTY0IiwiYSI6ImNpanQ2dnluOTBrdmh1MmtvOXI2eGNma2oifQ.rAJ_0MCV9U3A1Qbho1yHNw',*/ 'http://127.0.0.1:8000/SA4/{z}/{x}/{y}.pbf',
        layerName:/*'fid_sa4_2011_aust',*/ 'FID_SA4_2011_AUST',
        //csvItem: this,
