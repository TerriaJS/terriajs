...
function setNewRegionImageryLayer(regionMapping, layerIndex, regionIndices) {
    ...
    var regionImageryProvider = new MapboxVectorTileImageryProvider({
        url: /*'http://127.0.0.1:8000/SA4/{z}/{x}/{y}.pbf',*/ proxyCatalogItemUrl(catalogItem, regionDetail.regionProvider.server.url),
        layerName:/*'fid_sa4_2011_aust',*/ /* 'FID_SA4_2011_AUST',*/ regionDetail.regionProvider.layerName,
        //csvItem: this,
        colorFunc: colorFunction,
        subdomains: /*['a', 'b'],*/ regionDetail.regionProvider.server.subdomains,
        rectangle: /*new Rectangle(1.6897743921618487, -0.7634159159906613, 2.7769797418274336, -0.15956107199088243),*/ Rectangle.fromDegrees.apply(null, regionDetail.regionProvider.bbox),
