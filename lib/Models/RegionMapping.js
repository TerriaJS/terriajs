        ...
        return function constructMVTFeatureInfo(feature) {
            ...
            if (!regionMapping.hasActiveTimeColumn && !regionMapping.isPolled) {
                ...
                if (defined(cRowObject)) {
                    ...
                    imageryLayerFeatureInfo.properties = Object.assign({}, feature.properties, cRowObject.string);
                } else {
                    imageryLayerFeatureInfo.properties = Object.assign({}, feature.properties);
                }
            } else {
                // Time-varying.
                ...
                imageryLayerFeatureInfo.properties = new CallbackProperty(time => Object.assign({}, feature.properties, propertiesCallback(time)), false);
            }
