...
function addDescriptionAndProperties(regionMapping, regionIndices, regionImageryProvider) {
    ...
    function getRegionRowPropertiesPropertyCallbackForId(uniqueId) {
        ...
        return function regionRowPropertiesPropertyCallback(time, result) {
            ...
            var rowNumbersForThisRegion = rowNumbersMap[idStringForRowNumber];
...
function createNewRegionImageryLayer(regionMapping, layerIndex, regionIndices, globeOrMap) {
    ...
    case "MVT":
        // TODO: this structure won't handle all the subtleties of time-varying properties.
        // Also, the code above uses toStringAndNumberRowObjects not toRowObjects now.
