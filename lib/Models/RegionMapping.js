...
defineProperties(RegionMapping.prototype, {
   ...
   isLoading: {
     ...
     * There are two reasons that it might be time-varying - either there is a time column, or the data is periodically re-polled.
     * @memberOf RegionMapping.prototype
     * @type {Boolean}
     */
    isConstant: {
        get: function() {
            return !this.hasActiveTimeColumn && !this.isPolled;
        }
    }
        ...
        regionImageryProvider = new MapboxVectorTileImageryProvider({
            ...
            styleFunc: function(id) {
                ...
                return color ? {
                    ...
                    strokeStyle: catalogItem.terria.baseMapContrastColor,
                    lineWidth: 1
                } : undefined;
            },
