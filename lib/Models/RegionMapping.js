...
var createRegionProviderFromGeoJson = require("../Map/createRegionProviderFromGeoJson").default;
  ...
  switch (regionDetail.regionProvider.serverType) {
    case "MVT":
      ...
      regionImageryProvider = new MapboxVectorTileImageryProvider({
        tileIndex: typeof regionDetail.regionProvider.server !== "string" ? regionDetail.regionProvider.server : undefined,
        url: typeof regionDetail.regionProvider.server === "string" ? regionDetail.regionProvider.server : undefined,
