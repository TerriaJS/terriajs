...
var RegionMapping = function(catalogItem, tableStructure, tableStyle) {
    ...
    knockout.getObservable(this._tableStructure, 'activeItems').subscribe(this.changedActiveItems.bind(this), this);
};
 ...
 */
RegionMapping.prototype.changedActiveItems = function() {
