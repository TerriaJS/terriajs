...
function addDescriptionAndProperties(regionMapping, regionIndices, regionImageryProvider) {
    var tableStructure = regionMapping._tableStructure;
    // Use toNameAndIdRowObjects instead of toRowObjects so that templates can pick up
    // columns by either the name or the id (ie. tableColumnStyle.name or the csv column name).
