...
*/
var RegionMapping = function(catalogItem, tableStructure) {
...
RegionMapping.create = function(tableStructure, tableStyle) {
    ...
    return regionMapping;
        ...
        return that.loadRegionDetails().then(function(regionDetails) {
            if (regionDetails) {
 ...
 */
RegionMapping.prototype.setupClock = function() {
    var that = this;
