...
var featureDataToGeoJson = require('../Map/featureDataToGeoJson.js')
...
var ArcGisFeatureServerCatalogItem = function(terria) {
    ...
    /**
     * Gets or sets a value indicating whether to continue showing tiles when the {@link ArcGisFeatureServerCatalogItem#maximumScaleBeforeMessage}
...
inherit(ImageryLayerCatalogItem, ArcGisFeatureServerCatalogItem);
...
defineProperties(ArcGisFeatureServerCatalogItem.prototype, {
    ...
    /**
     * Gets a human-readable name for this type of data source, 'Esri ArcGIS FeatureServer'.
     * @memberOf ArcGisFeatureServerCatalogItem.prototype
     * @type {String}
     */
    typeName: {
        get: function() {
            return 'Esri ArcGIS FeatureServer';
        }
    },
...
/*
 Goal: To match URLs ending in FeatureServer/0 where 0 is any number
 but also allowing for an optional final /, and ? and # terms.
 For simplicity, match any path that includes /FeatureServer/0
 */
var partsRegex = new RegExp('^(.*\/FeatureServer\/)([0-9]+)', 'i');
...
ArcGisFeatureServerCatalogItem.prototype._createImageryProvider = function() {
 ...
 */
ArcGisFeatureServerCatalogItem.prototype.updateFromMetadata = function(mapServerJson, layersJson, legendJson, overwrite, thisLayerJson) {
    var i;
 ...
 * @return {Promise}
 */
ArcGisFeatureServerCatalogItem.prototype.loadLegendFromJson = function(json) {
    var options = {title: ''};
