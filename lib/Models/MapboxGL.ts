...
export default class MapboxGL extends GlobeOrMap {
  ...
  //     allImageryMapItems.forEach(imageryPart => {
  //       const ip = imageryPart.parts.imageryProvider
  //       if (ip instanceof WebMapServiceImageryProvider) {
  //         ip.
  //       }
  //     })
