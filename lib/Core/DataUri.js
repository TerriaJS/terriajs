...
var TerriaError = require("./TerriaError");
      ...
      if (defined(errorEvent)) {
        errorEvent.raiseEvent(
          new TerriaError({
            ...
            message:
              "Unfortunately Microsoft browsers (including all versions of Internet Explorer and Edge) do not " +
              "support the data uri functionality needed to download data as a file. To download, copy the following uri " +
              "into another browser such as Chrome, Firefox or Safari: " +
              href
          })
        );
      }
