 ...
 * @param {Array} [displayVariableTypes] Which variable types to show in the NowViewing tab. Defaults to ENUM, SCALAR, and ALT (not LAT, LON or TIME).
 */
    ...
    columns: {
        ...
        set: function(value) {
            if (areColumnsEqualLength(value)) {
                ...
                throw new DeveloperError('Badly formed data table - columns have different lengths.');
            }
        }
    }
});
