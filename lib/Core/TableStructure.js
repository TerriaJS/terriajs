...
var defaultDisplayVariableTypes = [VarType.ENUM, VarType.SCALAR, VarType.ALT, VarType.TIME];
 ...
 * @param {Array} [displayVariableTypes] Which variable types to show in the NowViewing tab. Defaults to ENUM, SCALAR, ALT and TIME (not LAT or LON).
 */
