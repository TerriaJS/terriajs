...
var formatNumberToLocale = require('./formatNumberToLocale');
...
* @param {Object} [options] Number formatting options, passed to formatNumberToLocale.
*/
function formatPropertyValue(value, options) {
    if (typeof value === 'number') {
        return formatNumberToLocale(value, options);
    } else
