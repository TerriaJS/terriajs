...
var TableColumn = function(name, values, options) {
    ...
    if ((this._type === VarType.SCALAR) && (this._numericalValues.length > 0)) {
        // Before setting this._values, replace '-' and 'NA' etc with null. Min/max values ignore nulls.
        this._values = replaceValues(values, defaultValue(this.options.replaceWithNullValues, defaultReplaceWithNullValues));
    } else {
        this._values = values;
    }
