...
* HTML and Markdown in catalog item metadata, feature information, etc. is now formatted in a more typical way.  For example, text `<h1>` now looks like a heading.  Previously, most HTML styling was stripped out.
