...
- Allow using Cesium in `SCENE2D` mode (and WebMercator projection) as map viewer.
- Add a new configuration parameter `mapViewers` to specify which mapViewers will be visible and usable in in `SettingPanel`.
