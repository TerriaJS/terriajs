...
describe("ArcGisFeatureServerCatalogGroup", function () {
  ...
  describe("loadMembers", function () {
    it("properly creates members", async function () {
      ...
      let member0 = group.memberModels[0] as ArcGisFeatureServerCatalogItem;
      let member1 = group.memberModels[1] as ArcGisFeatureServerCatalogItem;
      let member2 = group.memberModels[2] as ArcGisFeatureServerCatalogItem;
