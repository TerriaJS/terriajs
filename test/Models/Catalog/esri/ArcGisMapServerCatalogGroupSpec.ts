...
describe("ArcGisMapServerCatalogGroup", function () {
  ...
  describe("loadMembers", function () {
    it("properly creates members", async function () {
      ...
      let member0 = group.memberModels[0] as ArcGisMapServerCatalogItem;
      let member1 = group.memberModels[1] as ArcGisMapServerCatalogItem;
      let member2 = group.memberModels[2] as ArcGisMapServerCatalogItem;
      ...
      let member4 = member3.memberModels[0] as ArcGisMapServerCatalogGroup;
      let member5 = member3.memberModels[1] as ArcGisMapServerCatalogGroup;
