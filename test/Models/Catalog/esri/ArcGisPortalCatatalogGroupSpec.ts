...
describe("ArcGisPortalCatalogGroup", function () {
  ...
  describe("default settings - ", function () {
    ...
    it("properly creates members when no grouping", function () {
      ...
      let member0 = portalCatalogGroup.memberModels[0] as CatalogGroup;
      let member1 = portalCatalogGroup.memberModels[1] as CatalogGroup;
  ...
  describe("groupBy portal groups - ", function () {
    ...
    it("Ungrouped group created", function () {
      let member3 = portalCatalogGroup.memberModels[2] as CatalogGroup;
    ...
    it("Creates members from portal groups", function () {
      ...
      let member1 = portalCatalogGroup.memberModels[0] as CatalogGroup;
      expect(member1.name).toBe("NSW Digital Twin");

      let member2 = portalCatalogGroup.memberModels[1] as CatalogGroup;
    ...
    it("properly creates members within groups", function () {
      if (portalServerStratum !== undefined) {
        if (portalServerStratum.groups) {
          let group0 = portalServerStratum.groups[0] as CatalogGroup;
          ...
          let group1 = portalServerStratum.groups[1] as CatalogGroup;
