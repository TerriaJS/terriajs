...
describe("ThreddsCatalogGroup", function () {
  ...
  it("properly creates members ", async function () {
    ...
    let member0 = threddsCatalogGroup.memberModels[0] as CatalogGroup;
    ...
    let member1 = threddsCatalogGroup.memberModels[1] as CatalogGroup;
    ...
    let member2 = threddsCatalogGroup
