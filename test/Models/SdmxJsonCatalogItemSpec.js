...
describe('SdmxJsonCatalogItem', function() {
    ...
    describe('loading', function() {
        ...
        var dataflowFoo, dataflowFooTotal, dataFoo, dataFooTotal, dataFooBD2, dataFooBD2t, dataFoo2, dataNonSpatial, dataAsObs, dataAsObsRepeated;
        beforeEach(function(done) {
            when.all([
                ...
                loadText('test/SDMX-JSON/data-foo-with-total-2013.json').then(function(text) { dataFooTotal = text; }),
                ...
                jasmine.Ajax.stubRequest('http://sdmx.example.com/sdmx-json/data/FOO-TOT/.LGA_2013..A/all?startTime=2013&endTime=2013').andReturn({ responseText: dataFooTotal });
        ...
        it('works with dimensions with supplied hierarchical dimensionValues', function(done) {
            item.updateFromJson({
                name: 'Foo',
                url: 'http://sdmx.example.com/sdmx-json/data/FOO-TOT/.LGA_2013..A/all?startTime=2013&endTime=2013',
                hierarchicalValues: {
                    'MEASURE': [{
                        id: 'TOT',
                        children: [{
            ...
            item.load().then(function() {
                ...
                expect(item.concepts[0].items.length).toEqual(1);  // The MEASURE concept.
