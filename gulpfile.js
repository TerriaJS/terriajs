...
function generateCatalogMemberPages(schemaPath, outputPath) {
    ...
    typeFiles.forEach(function(typeFile) {
        ...
        var content = '!!! note\r\r' +
                      ...
                      '    trouble, check the [source code for this type](https://github.com/TerriaJS/terriajs/blob/terriajs7/lib/Models/' + path.basename(propertiesFile, '.json') + '.js) or post a message to the [forum](https://github.com/TerriaJS/terriajs/discussions).\r\r';
